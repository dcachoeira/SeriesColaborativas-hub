/*
               File: Gx00A0
        Description: Selection List Usuário recomendação episódios
...
namespace GeneXus.Programs {
   public class gx00a0 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         return "Selection List Usuário recomendação episódios" ;
      }
      ...
      protected void WB240( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblusuariorecomendacaoepisodiodatahorafilter_Internalname, "Data e hora da recomendação", "", "", lblLblusuariorecomendacaoepisodiodatahorafilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e14241_client"+"'", "", "WWAdvancedLabel WWDateFilterLabel", 7, "", 1, 1, 1, "HLP_Gx00A0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCusuariorecomendacaoepisodiodatahora_Internalname, "Data e hora da recomendação", "col-sm-3 AttributeLabel", 0, true);
            /* Single line edit */
      ...
      protected void START242( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Selection List Usuário recomendação episódios", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP240( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            {
               GX_msglist.addItem(context.GetMessage( "GXM_baddatetime", new   object[]  {"Data e hora da recomendação"}), 1, "vCUSUARIORECOMENDACAOEPISODIODATAHORA");
      ...
      {
         /* Start Routine */
         Form.Caption = StringUtil.Format( "Lista de Seleção %1", "Usuário recomendação episódios", "", "", "", "", "", "", "", "");
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Selection List Usuário recomendação episódios";
         subGrid1_Rows = 10;
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
