/*
               File: GAMRecoverPasswordStep2
        Description: Recover Password
             Author: GeneXus C# Generator version 15_0_9-121631
       Generated on: 9/20/2018 19:44:11.66
...
namespace GeneXus.Programs {
   public class gamrecoverpasswordstep2 : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public void execute( String aP0_KeyToChangePassword )
      {
         this.AV10KeyToChangePassword = aP0_KeyToChangePassword;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10KeyToChangePassword = gxfirstwebparm;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10KeyToChangePassword", AV10KeyToChangePassword);
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vKEYTOCHANGEPASSWORD", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV10KeyToChangePassword, "")), context));
            }
            if ( context.isSpaRequest( ) )
            {
               enableJsOutput();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?201892019441190", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gamrecoverpasswordstep2.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV10KeyToChangePassword))+"\">") ;
      ...
      protected void WB1A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "Center", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSignin_Internalname, "ENTER NEW PASSWORD", "", "", lblSignin_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleLogin", 0, "", 1, 1, 0, "HLP_GAMRecoverPasswordStep2.htm");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 CellMarginTop", "Center", "top", "", "", "div");
            wb_table1_21_1A2( true) ;
         }
         else
         {
            wb_table1_21_1A2( false) ;
         }
         return  ;
      }

      protected void wb_table1_21_1A2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "Center", "top", "div");
      ...
      protected void STRUP1A0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV15UserName", AV15UserName);
            AV16UserPasswordNew = cgiGet( edtavUserpasswordnew_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV16UserPasswordNew", AV16UserPasswordNew);
            AV17UserPasswordNewConf = cgiGet( edtavUserpasswordnewconf_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV17UserPasswordNewConf", AV17UserPasswordNewConf);
            /* Read saved values. */
      ...
      protected void E121A2( )
      {
         ...
         {
            AV13User = new SdtGAMRepository(context).getuserbylogin(AV14UserAuthTypeName, AV15UserName, out  AV9Errors);
            if ( AV9Errors.Count == 0 )
            {
               ...
               if ( AV7ChangePwdOK )
               {
                  pr_gam.commit( "GAMRecoverPasswordStep2");
                  pr_default.commit( "GAMRecoverPasswordStep2");
                  AV5AdditionalParameter.gxTpr_Rememberusertype = AV18UserRememberMe;
                  AV11LoginOK = new SdtGAMRepository(context).login(AV15UserName, AV16UserPasswordNew, AV5AdditionalParameter, out  AV9Errors);
                  if ( AV11LoginOK )
                  {
                     if ( new SdtGAMRepository(context).isremoteauthentication(AV6ApplciationClientId) )
                     {
      ...
      protected void S112( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, divTableerror_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(divTableerror_Visible), 5, 0)), true);
         AV23GXV1 = 1;
         while ( AV23GXV1 <= AV9Errors.Count )
         {
            AV8Error = ((SdtGAMError)AV9Errors.Item(AV23GXV1));
            GX_msglist.addItem(StringUtil.Format( "%1", AV8Error.gxTpr_Message, "", "", "", "", "", "", "", ""));
      ...
      protected void wb_table1_21_1A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsername_Internalname, AV15UserName, StringUtil.RTrim( context.localUtil.Format( AV15UserName, "")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,25);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "User", edtavUsername_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavUsername_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, 0, true, "GAMEMail", "left", true, "HLP_GAMRecoverPasswordStep2.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "", "Confirm", bttBtnenter_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMRecoverPasswordStep2.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancel_Internalname, "", "Back to Login", bttBtncancel_Jsonclick, 1, "Fechar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMRecoverPasswordStep2.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            ...
            wb_table1_21_1A2e( true) ;
         }
         else
         {
            wb_table1_21_1A2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10KeyToChangePassword = (String)getParm(obj,0);
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10KeyToChangePassword", AV10KeyToChangePassword);
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vKEYTOCHANGEPASSWORD", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV10KeyToChangePassword, "")), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?201892019441636", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamrecoverpasswordstep2.js", "?201892019441638", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10KeyToChangePassword',fld:'vKEYTOCHANGEPASSWORD',pic:'',hsh:true,nv:''}],oparms:[]}");
         setEventMetadata("ENTER","{handler:'E121A2',iparms:[{av:'AV16UserPasswordNew',fld:'vUSERPASSWORDNEW',pic:'',nv:''},{av:'AV17UserPasswordNewConf',fld:'vUSERPASSWORDNEWCONF',pic:'',nv:''},{av:'AV14UserAuthTypeName',fld:'vUSERAUTHTYPENAME',pic:'',nv:''},{av:'AV15UserName',fld:'vUSERNAME',pic:'',nv:''},{av:'AV10KeyToChangePassword',fld:'vKEYTOCHANGEPASSWORD',pic:'',hsh:true,nv:''},{av:'AV18UserRememberMe',fld:'vUSERREMEMBERME',pic:'Z9',nv:0},{av:'AV6ApplciationClientId',fld:'vAPPLCIATIONCLIENTID',pic:'',nv:''}],oparms:[{av:'divTableerror_Visible',ctrl:'TABLEERROR',prop:'Visible'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV13User = new SdtGAMUser(context);
