/*
       ...
       Generated on: 9/20/2018 19:40:18.60
...
namespace GeneXus.Programs {
   public class gamwwroles : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxNewRow_"+"Gridww") == 0 )
            {
               ...
               context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnrole_Internalname, "Title", edtavBtnrole_Title, !bGXsfl_41_Refreshing);
               edtavBtnprm_Title = GetNextPar( );
               context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnprm_Internalname, "Title", edtavBtnprm_Title, !bGXsfl_41_Refreshing);
               edtavBtnsaveas_Title = GetNextPar( );
               context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnsaveas_Internalname, "Title", edtavBtnsaveas_Title, !bGXsfl_41_Refreshing);
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Gridww") == 0 )
            {
               ...
               edtavBtnsaveas_Title = GetNextPar( );
               context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnsaveas_Internalname, "Title", edtavBtnsaveas_Title, !bGXsfl_41_Refreshing);
               AV24FilName = GetNextPar( );
               AV23FilExternalId = GetNextPar( );
               AV30IsAuthorized_BtnUpd = (bool)(BooleanUtil.Val(GetNextPar( )));
               AV27IsAuthorized_BtnDlt = (bool)(BooleanUtil.Val(GetNextPar( )));
               AV29IsAuthorized_BtnRole = (bool)(BooleanUtil.Val(GetNextPar( )));
               AV28IsAuthorized_BtnPrm = (bool)(BooleanUtil.Val(GetNextPar( )));
               ...
               gxgrGridww_refresh( subGridww_Rows, AV24FilName, AV23FilExternalId, AV30IsAuthorized_BtnUpd, AV27IsAuthorized_BtnDlt, AV29IsAuthorized_BtnRole, AV28IsAuthorized_BtnPrm, AV31IsAuthorized_Name) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?201892019401913", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gamwwroles.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vGRIDWWPAGECOUNT", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV26GridWWPageCount), 10, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vFILEXTERNALID", StringUtil.RTrim( AV23FilExternalId));
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_BTNROLE", AV29IsAuthorized_BtnRole);
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_BTNPRM", AV28IsAuthorized_BtnPrm);
      ...
      protected void WB0N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnadd_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(41), 2, 0)+","+"null"+");", "Insert", bttBtnadd_Jsonclick, 7, "Insert", "", StyleString, ClassString, bttBtnadd_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"e110n1_client"+"'", TempTags, "", 2, "HLP_GAMWWRoles.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            wb_table1_27_0N2( true) ;
         }
         else
         {
            wb_table1_27_0N2( false) ;
         }
         return  ;
      }

      protected void wb_table1_27_0N2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            {
               context.WriteHtmlText( "<div id=\""+"GridwwContainer"+"DivS\" data-gxgridid=\"41\">") ;
               sStyleString = "";
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"ActionBaseColorAttribute"+"\" "+" style=\""+((edtavBtnprm_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
            ...
            else
            {
               ...
               GridwwColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridwwColumn.AddObjectProperty("Value", context.convertURL( AV19BtnDlt));
               ...
               GridwwContainer.AddColumnProperties(GridwwColumn);
               GridwwColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridwwColumn.AddObjectProperty("Value", context.convertURL( AV21BtnRole));
               GridwwColumn.AddObjectProperty("Title", StringUtil.RTrim( edtavBtnrole_Title));
               GridwwColumn.AddObjectProperty("Link", StringUtil.RTrim( edtavBtnrole_Link));
               GridwwColumn.AddObjectProperty("Tooltiptext", StringUtil.RTrim( edtavBtnrole_Tooltiptext));
               GridwwColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavBtnrole_Visible), 5, 0, ".", "")));
               GridwwContainer.AddColumnProperties(GridwwColumn);
               GridwwColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridwwColumn.AddObjectProperty("Value", context.convertURL( AV20BtnPrm));
               GridwwColumn.AddObjectProperty("Title", StringUtil.RTrim( edtavBtnprm_Title));
               GridwwColumn.AddObjectProperty("Link", StringUtil.RTrim( edtavBtnprm_Link));
               GridwwColumn.AddObjectProperty("Tooltiptext", StringUtil.RTrim( edtavBtnprm_Tooltiptext));
               GridwwColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavBtnprm_Visible), 5, 0, ".", "")));
               GridwwContainer.AddColumnProperties(GridwwColumn);
               GridwwColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridwwColumn.AddObjectProperty("Value", context.convertURL( AV5BtnSaveAs));
               GridwwColumn.AddObjectProperty("Title", StringUtil.RTrim( edtavBtnsaveas_Title));
               GridwwColumn.AddObjectProperty("Tooltiptext", StringUtil.RTrim( edtavBtnsaveas_Tooltiptext));
               GridwwContainer.AddColumnProperties(GridwwColumn);
               GridwwColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         ...
         if ( wbEnd == 41 )
         {
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 53,'',false,'" + sGXsfl_41_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavGridwwcurrentpage_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV25GridWWCurrentPage), 10, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV25GridWWCurrentPage), "ZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,53);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavGridwwcurrentpage_Jsonclick, 0, "Attribute", "", "", "", "", edtavGridwwcurrentpage_Visible, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_GAMWWRoles.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 11), "GRIDWW.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 16), "VBTNSAVEAS.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 16), "VBTNSAVEAS.CLICK") == 0 ) )
                           {
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnupd_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV6BtnUpd)) ? AV43Btnupd_GXI : context.convertURL( context.PathToRelativeUrl( AV6BtnUpd))), !bGXsfl_41_Refreshing);
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnupd_Internalname, "SrcSet", context.GetImageSrcSet( AV6BtnUpd), true);
                              AV19BtnDlt = cgiGet( edtavBtndlt_Internalname);
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtndlt_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV19BtnDlt)) ? AV44Btndlt_GXI : context.convertURL( context.PathToRelativeUrl( AV19BtnDlt))), !bGXsfl_41_Refreshing);
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtndlt_Internalname, "SrcSet", context.GetImageSrcSet( AV19BtnDlt), true);
                              AV21BtnRole = cgiGet( edtavBtnrole_Internalname);
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnrole_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV21BtnRole)) ? AV45Btnrole_GXI : context.convertURL( context.PathToRelativeUrl( AV21BtnRole))), !bGXsfl_41_Refreshing);
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnrole_Internalname, "SrcSet", context.GetImageSrcSet( AV21BtnRole), true);
                              AV20BtnPrm = cgiGet( edtavBtnprm_Internalname);
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnprm_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV20BtnPrm)) ? AV46Btnprm_GXI : context.convertURL( context.PathToRelativeUrl( AV20BtnPrm))), !bGXsfl_41_Refreshing);
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnprm_Internalname, "SrcSet", context.GetImageSrcSet( AV20BtnPrm), true);
                              AV5BtnSaveAs = cgiGet( edtavBtnsaveas_Internalname);
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnsaveas_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV5BtnSaveAs)) ? AV47Btnsaveas_GXI : context.convertURL( context.PathToRelativeUrl( AV5BtnSaveAs))), !bGXsfl_41_Refreshing);
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnsaveas_Internalname, "SrcSet", context.GetImageSrcSet( AV5BtnSaveAs), true);
                              AV14Name = cgiGet( edtavName_Internalname);
                              context.httpAjaxContext.ajax_rsp_assign_attri("", false, edtavName_Internalname, AV14Name);
                              if ( ( ( context.localUtil.CToN( cgiGet( edtavId_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavId_Internalname), ",", ".") > Convert.ToDecimal( 999999999999L )) ) )
                              {
                                 ...
                                 wbErr = true;
                                 AV12Id = 0;
                                 context.httpAjaxContext.ajax_rsp_assign_attri("", false, edtavId_Internalname, StringUtil.LTrim( StringUtil.Str( (decimal)(AV12Id), 12, 0)));
                                 context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vID"+"_"+sGXsfl_41_idx, GetSecureSignedToken( sGXsfl_41_idx, context.localUtil.Format( (decimal)(AV12Id), "ZZZZZZZZZZZ9"), context));
                              }
                              else
                              {
      ...
      protected void gxnrGridww_newrow( )
      {
         ...
         {
            sendrow_412( ) ;
            nGXsfl_41_idx = (short)(((subGridww_Islastpage==1)&&(nGXsfl_41_idx+1>subGridww_Recordsperpage( )) ? 1 : nGXsfl_41_idx+1));
            sGXsfl_41_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_41_idx), 4, 0)), 4, "0");
            SubsflControlProps_412( ) ;
         }
      ...
      protected void gxgrGridww_refresh( int subGridww_Rows ,
                                         String AV24FilName ,
                                         String AV23FilExternalId ,
                                         bool AV30IsAuthorized_BtnUpd ,
                                         bool AV27IsAuthorized_BtnDlt ,
                                         bool AV29IsAuthorized_BtnRole ,
                                         bool AV28IsAuthorized_BtnPrm ,
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12Id), "ZZZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12Id), 12, 0, ".", "")));
      }
      ...
      protected void initialize_formulas( )
      {
         ...
         context.Gx_err = 0;
         edtavName_Enabled = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavName_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavName_Enabled), 5, 0)), !bGXsfl_41_Refreshing);
         edtavId_Enabled = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavId_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavId_Enabled), 5, 0)), !bGXsfl_41_Refreshing);
      }
      ...
      protected void RF0N2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            SubsflControlProps_412( ) ;
            E160N2 ();
            if ( ( GRIDWW_nCurrentRecord > 0 ) && ( GRIDWW_nGridOutOfScope == 0 ) && ( nGXsfl_41_idx == 1 ) )
            {
               GRIDWW_nCurrentRecord = 0;
      ...
      protected void send_integrity_lvl_hashes0N2( )
      {
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_NAME", AV31IsAuthorized_Name);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_NAME", GetSecureSignedToken( "", AV31IsAuthorized_Name, context));
         GxWebStd.gx_hidden_field( context, "gxhash_vID"+"_"+sGXsfl_41_idx, GetSecureSignedToken( sGXsfl_41_idx, context.localUtil.Format( (decimal)(AV12Id), "ZZZZZZZZZZZ9"), context));
      }
      ...
      protected void STRUP0N0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavGridwwcurrentpage_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavGridwwcurrentpage_Internalname), ",", ".") > Convert.ToDecimal( 9999999999L )) ) )
            {
               ...
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV25GridWWCurrentPage = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV25GridWWCurrentPage", StringUtil.LTrim( StringUtil.Str( (decimal)(AV25GridWWCurrentPage), 10, 0)));
            }
            else
            {
               AV25GridWWCurrentPage = (long)(context.localUtil.CToN( cgiGet( edtavGridwwcurrentpage_Internalname), ",", "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV25GridWWCurrentPage", StringUtil.LTrim( StringUtil.Str( (decimal)(AV25GridWWCurrentPage), 10, 0)));
            }
            /* Read saved values. */
            nRC_GXsfl_41 = (short)(context.localUtil.CToN( cgiGet( "nRC_GXsfl_41"), ",", "."));
            AV26GridWWPageCount = (long)(context.localUtil.CToN( cgiGet( "vGRIDWWPAGECOUNT"), ",", "."));
      ...
      protected void E140N2( )
      {
         ...
         AV26GridWWPageCount = -1;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV26GridWWPageCount", StringUtil.LTrim( StringUtil.Str( (decimal)(AV26GridWWPageCount), 10, 0)));
      ...
      {
         /* Gridww_Load Routine */
         AV11Filter.gxTpr_Name = "%"+AV24FilName;
         AV11Filter.gxTpr_Externalid = "%"+AV23FilExternalId;
         AV34GAMRoles = new SdtGAMRepository(context).getroles(AV11Filter, out  AV10Errors);
         if ( AV34GAMRoles.Count == 0 )
         {
            AV26GridWWPageCount = 0;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV26GridWWPageCount", StringUtil.LTrim( StringUtil.Str( (decimal)(AV26GridWWPageCount), 10, 0)));
         }
         else
         {
            AV26GridWWPageCount = (long)((AV34GAMRoles.Count/ (decimal)(9))+1);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV26GridWWPageCount", StringUtil.LTrim( StringUtil.Str( (decimal)(AV26GridWWPageCount), 10, 0)));
         }
         AV36GridWWRecordCount = AV34GAMRoles.Count;
         AV35GridWWPageSize = 9;
         AV42GXV1 = 1;
         while ( AV42GXV1 <= AV34GAMRoles.Count )
         {
            AV16Role = ((SdtGAMRole)AV34GAMRoles.Item(AV42GXV1));
            ...
            {
               edtavBtnupd_Link = formatLink("gamroleentry.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +AV12Id);
            }
            AV19BtnDlt = context.GetImagePath( "7695fe89-52c9-4b7e-871e-0e11548f823e", "", context.GetTheme( ));
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, edtavBtndlt_Internalname, AV19BtnDlt);
            ...
            {
               edtavBtndlt_Link = formatLink("gamroleentry.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +AV12Id);
            }
            AV21BtnRole = context.GetImagePath( "1399ecfa-9434-44f7-87ac-cbf49b0a76d5", "", context.GetTheme( ));
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, edtavBtnrole_Internalname, AV21BtnRole);
            AV45Btnrole_GXI = GXDbFile.PathToUrl( context.GetImagePath( "1399ecfa-9434-44f7-87ac-cbf49b0a76d5", "", context.GetTheme( )));
            edtavBtnrole_Tooltiptext = "Roles";
            if ( AV29IsAuthorized_BtnRole )
            {
               edtavBtnrole_Link = formatLink("gamwwroleroles.aspx") + "?" + UrlEncode("" +AV12Id) + "," + UrlEncode("" +AV12Id);
            }
            AV20BtnPrm = context.GetImagePath( "846cc5aa-e497-452c-bf2c-fdd868279a72", "", context.GetTheme( ));
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, edtavBtnprm_Internalname, AV20BtnPrm);
            AV46Btnprm_GXI = GXDbFile.PathToUrl( context.GetImagePath( "846cc5aa-e497-452c-bf2c-fdd868279a72", "", context.GetTheme( )));
            edtavBtnprm_Tooltiptext = "Permissions";
            if ( AV28IsAuthorized_BtnPrm )
            {
               edtavBtnprm_Link = formatLink("gamwwrolepermissions.aspx") + "?" + UrlEncode("" +AV12Id) + "," + UrlEncode("" +0);
            }
            AV5BtnSaveAs = context.GetImagePath( "7f618bea-47cd-4ba5-84d7-c430500a42e3", "", context.GetTheme( ));
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, edtavBtnsaveas_Internalname, AV5BtnSaveAs);
            AV47Btnsaveas_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7f618bea-47cd-4ba5-84d7-c430500a42e3", "", context.GetTheme( )));
            edtavBtnsaveas_Tooltiptext = "Copy";
            if ( AV31IsAuthorized_Name )
            {
               edtavName_Link = formatLink("gamroleentry.aspx") + "?" + UrlEncode(StringUtil.RTrim("DSP")) + "," + UrlEncode("" +AV12Id);
            }
            /* Load Method */
            if ( wbStart != -1 )
            {
            ...
            {
               context.DoAjaxLoad(41, GridwwRow);
            }
      ...
      protected void E120N2( )
      {
         ...
         {
            AV25GridWWCurrentPage = (long)(AV25GridWWCurrentPage-1);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV25GridWWCurrentPage", StringUtil.LTrim( StringUtil.Str( (decimal)(AV25GridWWCurrentPage), 10, 0)));
         ...
         else
         {
            ...
            AV25GridWWCurrentPage = AV32PageToGo;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV25GridWWCurrentPage", StringUtil.LTrim( StringUtil.Str( (decimal)(AV25GridWWCurrentPage), 10, 0)));
      ...
      protected void S112( )
      {
         ...
         if ( ! ( AV30IsAuthorized_BtnUpd ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnupd_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavBtnupd_Visible), 5, 0)), !bGXsfl_41_Refreshing);
         }
         ...
         if ( ! ( AV27IsAuthorized_BtnDlt ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtndlt_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavBtndlt_Visible), 5, 0)), !bGXsfl_41_Refreshing);
         }
         GXt_boolean1 = AV29IsAuthorized_BtnRole;
         ...
         AV29IsAuthorized_BtnRole = GXt_boolean1;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV29IsAuthorized_BtnRole", AV29IsAuthorized_BtnRole);
         if ( ! ( AV29IsAuthorized_BtnRole ) )
         {
            edtavBtnrole_Visible = 0;
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnrole_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavBtnrole_Visible), 5, 0)), !bGXsfl_41_Refreshing);
         }
         GXt_boolean1 = AV28IsAuthorized_BtnPrm;
         ...
         AV28IsAuthorized_BtnPrm = GXt_boolean1;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV28IsAuthorized_BtnPrm", AV28IsAuthorized_BtnPrm);
         if ( ! ( AV28IsAuthorized_BtnPrm ) )
         {
            edtavBtnprm_Visible = 0;
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnprm_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavBtnprm_Visible), 5, 0)), !bGXsfl_41_Refreshing);
         }
         GXt_boolean1 = AV33TempBoolean;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "gamroleentry_Execute", out  GXt_boolean1) ;
         AV33TempBoolean = GXt_boolean1;
         if ( ! ( AV33TempBoolean ) )
         {
            bttBtnadd_Visible = 0;
      ...
      protected void E170N2( )
      {
         ...
         if ( AV13isOK )
         {
            pr_gam.commit( "GAMWWRoles");
            pr_default.commit( "GAMWWRoles");
            context.DoAjaxRefresh();
         }
         else
         {
            AV48GXV2 = 1;
            while ( AV48GXV2 <= AV10Errors.Count )
            {
               AV9Error = ((SdtGAMError)AV10Errors.Item(AV48GXV2));
      ...
      protected void wb_table1_27_0N2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablefilters_Internalname, 1, 0, "px", 0, "px", "Table100x100", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilname_Internalname, StringUtil.RTrim( AV24FilName), StringUtil.RTrim( context.localUtil.Format( AV24FilName, "")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,35);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFilname_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilname_Enabled, 0, "text", "", 80, "chr", 1, "row", 254, 0, 0, 0, 1, -1, -1, true, "GAMDescriptionLong", "left", true, "HLP_GAMWWRoles.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_27_0N2e( true) ;
         }
         else
         {
            wb_table1_27_0N2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20189201940279", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("gamwwroles.js", "?201892019402711", false);
      ...
      {
         edtavBtnupd_Internalname = "vBTNUPD_"+sGXsfl_41_idx;
         edtavBtndlt_Internalname = "vBTNDLT_"+sGXsfl_41_idx;
         edtavBtnrole_Internalname = "vBTNROLE_"+sGXsfl_41_idx;
         edtavBtnprm_Internalname = "vBTNPRM_"+sGXsfl_41_idx;
         edtavBtnsaveas_Internalname = "vBTNSAVEAS_"+sGXsfl_41_idx;
      ...
      {
         edtavBtnupd_Internalname = "vBTNUPD_"+sGXsfl_41_fel_idx;
         edtavBtndlt_Internalname = "vBTNDLT_"+sGXsfl_41_fel_idx;
         edtavBtnrole_Internalname = "vBTNROLE_"+sGXsfl_41_fel_idx;
         edtavBtnprm_Internalname = "vBTNPRM_"+sGXsfl_41_fel_idx;
         edtavBtnsaveas_Internalname = "vBTNSAVEAS_"+sGXsfl_41_fel_idx;
      ...
      protected void sendrow_412( )
      {
         SubsflControlProps_412( ) ;
         WB0N0( ) ;
         if ( ( subGridww_Rows * 1 == 0 ) || ( nGXsfl_41_idx <= subGridww_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV6BtnUpd_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV6BtnUpd))&&String.IsNullOrEmpty(StringUtil.RTrim( AV43Btnupd_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV6BtnUpd)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV6BtnUpd)) ? AV43Btnupd_GXI : context.PathToRelativeUrl( AV6BtnUpd));
            ...
            StyleString = "";
            AV19BtnDlt_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV19BtnDlt))&&String.IsNullOrEmpty(StringUtil.RTrim( AV44Btndlt_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV19BtnDlt)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV19BtnDlt)) ? AV44Btndlt_GXI : context.PathToRelativeUrl( AV19BtnDlt));
            GridwwRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(String)edtavBtndlt_Internalname,(String)sImgUrl,(String)edtavBtndlt_Link,(String)"",(String)"",context.GetTheme( ),(int)edtavBtndlt_Visible,(short)1,(String)"",(String)edtavBtndlt_Tooltiptext,(short)0,(short)-1,(short)0,(String)"px",(short)0,(String)"px",(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)"WWActionColumn",(String)"",(String)"",(String)"",(String)"",(String)"",(String)"",(short)1,(bool)AV19BtnDlt_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridwwContainer.GetWrapped() == 1 )
            {
            ...
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV21BtnRole_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV21BtnRole))&&String.IsNullOrEmpty(StringUtil.RTrim( AV45Btnrole_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV21BtnRole)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV21BtnRole)) ? AV45Btnrole_GXI : context.PathToRelativeUrl( AV21BtnRole));
            GridwwRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(String)edtavBtnrole_Internalname,(String)sImgUrl,(String)edtavBtnrole_Link,(String)"",(String)"",context.GetTheme( ),(int)edtavBtnrole_Visible,(short)1,(String)"",(String)edtavBtnrole_Tooltiptext,(short)0,(short)-1,(short)0,(String)"px",(short)0,(String)"px",(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)"WWActionColumn hidden-xs",(String)"",(String)"",(String)"",(String)"",(String)"",(String)"",(short)1,(bool)AV21BtnRole_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridwwContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+((edtavBtnprm_Visible==0) ? "display:none;" : "")+"\">") ;
            }
            /* Static Bitmap Variable */
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV20BtnPrm_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV20BtnPrm))&&String.IsNullOrEmpty(StringUtil.RTrim( AV46Btnprm_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV20BtnPrm)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV20BtnPrm)) ? AV46Btnprm_GXI : context.PathToRelativeUrl( AV20BtnPrm));
            GridwwRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(String)edtavBtnprm_Internalname,(String)sImgUrl,(String)edtavBtnprm_Link,(String)"",(String)"",context.GetTheme( ),(int)edtavBtnprm_Visible,(short)1,(String)"",(String)edtavBtnprm_Tooltiptext,(short)0,(short)-1,(short)0,(String)"px",(short)0,(String)"px",(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)"WWActionColumn hidden-xs",(String)"",(String)"",(String)"",(String)"",(String)"",(String)"",(short)1,(bool)AV20BtnPrm_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridwwContainer.GetWrapped() == 1 )
            {
            ...
            TempTags = " " + ((edtavBtnsaveas_Enabled!=0)&&(edtavBtnsaveas_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 46,'',false,'',41)\"" : " ");
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV5BtnSaveAs_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV5BtnSaveAs))&&String.IsNullOrEmpty(StringUtil.RTrim( AV47Btnsaveas_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV5BtnSaveAs)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV5BtnSaveAs)) ? AV47Btnsaveas_GXI : context.PathToRelativeUrl( AV5BtnSaveAs));
            GridwwRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(String)edtavBtnsaveas_Internalname,(String)sImgUrl,(String)"",(String)"",(String)"",context.GetTheme( ),(short)-1,(short)1,(String)"",(String)edtavBtnsaveas_Tooltiptext,(short)0,(short)-1,(short)0,(String)"px",(short)0,(String)"px",(short)0,(short)0,(short)5,(String)edtavBtnsaveas_Jsonclick,"'"+""+"'"+",false,"+"'"+"EVBTNSAVEAS.CLICK."+sGXsfl_41_idx+"'",(String)StyleString,(String)ClassString,(String)"WWActionColumn hidden-xs",(String)"",(String)"",(String)"",(String)""+TempTags,(String)"",(String)"",(short)1,(bool)AV5BtnSaveAs_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridwwContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            TempTags = " " + ((edtavId_Enabled!=0)&&(edtavId_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 48,'',false,'"+sGXsfl_41_idx+"',41)\"" : " ");
            ROClassString = "Attribute";
            GridwwRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtavId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12Id), 12, 0, ",", "")),((edtavId_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV12Id), "ZZZZZZZZZZZ9")) : context.localUtil.Format( (decimal)(AV12Id), "ZZZZZZZZZZZ9")),TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+((edtavId_Enabled!=0)&&(edtavId_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,48);\"" : " "),(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtavId_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn",(String)"",(short)0,(int)edtavId_Enabled,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)12,(short)0,(short)0,(short)41,(short)1,(short)-1,(short)0,(bool)true,(String)"GAMKeyNumLong",(String)"right",(bool)false});
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRIDWW_nFirstRecordOnPage',nv:0},{av:'GRIDWW_nEOF',nv:0},{av:'subGridww_Rows',nv:0},{av:'edtavBtnrole_Title',ctrl:'vBTNROLE',prop:'Title'},{av:'edtavBtnprm_Title',ctrl:'vBTNPRM',prop:'Title'},{av:'edtavBtnsaveas_Title',ctrl:'vBTNSAVEAS',prop:'Title'},{av:'AV24FilName',fld:'vFILNAME',pic:'',nv:''},{av:'AV23FilExternalId',fld:'vFILEXTERNALID',pic:'',nv:''},{av:'AV30IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'AV27IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'AV29IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',nv:false},{av:'AV28IsAuthorized_BtnPrm',fld:'vISAUTHORIZED_BTNPRM',pic:'',nv:false},{av:'AV31IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true,nv:false}],oparms:[{av:'AV30IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'edtavBtnupd_Visible',ctrl:'vBTNUPD',prop:'Visible'},{av:'AV27IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'edtavBtndlt_Visible',ctrl:'vBTNDLT',prop:'Visible'},{av:'AV29IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',nv:false},{av:'edtavBtnrole_Visible',ctrl:'vBTNROLE',prop:'Visible'},{av:'AV28IsAuthorized_BtnPrm',fld:'vISAUTHORIZED_BTNPRM',pic:'',nv:false},{av:'edtavBtnprm_Visible',ctrl:'vBTNPRM',prop:'Visible'},{ctrl:'BTNADD',prop:'Visible'}]}");
         setEventMetadata("GRIDWW.LOAD","{handler:'E160N2',iparms:[{av:'AV24FilName',fld:'vFILNAME',pic:'',nv:''},{av:'AV23FilExternalId',fld:'vFILEXTERNALID',pic:'',nv:''},{av:'AV30IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'AV27IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'AV29IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',nv:false},{av:'AV28IsAuthorized_BtnPrm',fld:'vISAUTHORIZED_BTNPRM',pic:'',nv:false},{av:'AV31IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true,nv:false}],oparms:[{av:'AV26GridWWPageCount',fld:'vGRIDWWPAGECOUNT',pic:'ZZZZZZZZZ9',nv:0},{av:'AV12Id',fld:'vID',pic:'ZZZZZZZZZZZ9',hsh:true,nv:0},{av:'AV14Name',fld:'vNAME',pic:'',nv:''},{av:'AV6BtnUpd',fld:'vBTNUPD',pic:'',nv:''},{av:'edtavBtnupd_Tooltiptext',ctrl:'vBTNUPD',prop:'Tooltiptext'},{av:'edtavBtnupd_Link',ctrl:'vBTNUPD',prop:'Link'},{av:'AV19BtnDlt',fld:'vBTNDLT',pic:'',nv:''},{av:'edtavBtndlt_Tooltiptext',ctrl:'vBTNDLT',prop:'Tooltiptext'},{av:'edtavBtndlt_Link',ctrl:'vBTNDLT',prop:'Link'},{av:'AV21BtnRole',fld:'vBTNROLE',pic:'',nv:''},{av:'edtavBtnrole_Tooltiptext',ctrl:'vBTNROLE',prop:'Tooltiptext'},{av:'edtavBtnrole_Link',ctrl:'vBTNROLE',prop:'Link'},{av:'AV20BtnPrm',fld:'vBTNPRM',pic:'',nv:''},{av:'edtavBtnprm_Tooltiptext',ctrl:'vBTNPRM',prop:'Tooltiptext'},{av:'edtavBtnprm_Link',ctrl:'vBTNPRM',prop:'Link'},{av:'AV5BtnSaveAs',fld:'vBTNSAVEAS',pic:'',nv:''},{av:'edtavBtnsaveas_Tooltiptext',ctrl:'vBTNSAVEAS',prop:'Tooltiptext'},{av:'edtavName_Link',ctrl:'vNAME',prop:'Link'}]}");
         setEventMetadata("GRIDWWPAGINATIONBAR.CHANGEPAGE","{handler:'E120N2',iparms:[{av:'GRIDWW_nFirstRecordOnPage',nv:0},{av:'GRIDWW_nEOF',nv:0},{av:'subGridww_Rows',nv:0},{av:'edtavBtnrole_Title',ctrl:'vBTNROLE',prop:'Title'},{av:'edtavBtnprm_Title',ctrl:'vBTNPRM',prop:'Title'},{av:'edtavBtnsaveas_Title',ctrl:'vBTNSAVEAS',prop:'Title'},{av:'AV24FilName',fld:'vFILNAME',pic:'',nv:''},{av:'AV23FilExternalId',fld:'vFILEXTERNALID',pic:'',nv:''},{av:'AV30IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'AV27IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'AV29IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',nv:false},{av:'AV28IsAuthorized_BtnPrm',fld:'vISAUTHORIZED_BTNPRM',pic:'',nv:false},{av:'AV31IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true,nv:false},{av:'Gridwwpaginationbar_Selectedpage',ctrl:'GRIDWWPAGINATIONBAR',prop:'SelectedPage'},{av:'AV25GridWWCurrentPage',fld:'vGRIDWWCURRENTPAGE',pic:'ZZZZZZZZZ9',nv:0}],oparms:[{av:'AV25GridWWCurrentPage',fld:'vGRIDWWCURRENTPAGE',pic:'ZZZZZZZZZ9',nv:0},{av:'AV30IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'edtavBtnupd_Visible',ctrl:'vBTNUPD',prop:'Visible'},{av:'AV27IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'edtavBtndlt_Visible',ctrl:'vBTNDLT',prop:'Visible'},{av:'AV29IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',nv:false},{av:'edtavBtnrole_Visible',ctrl:'vBTNROLE',prop:'Visible'},{av:'AV28IsAuthorized_BtnPrm',fld:'vISAUTHORIZED_BTNPRM',pic:'',nv:false},{av:'edtavBtnprm_Visible',ctrl:'vBTNPRM',prop:'Visible'},{ctrl:'BTNADD',prop:'Visible'}]}");
         setEventMetadata("GRIDWWPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E130N2',iparms:[{av:'GRIDWW_nFirstRecordOnPage',nv:0},{av:'GRIDWW_nEOF',nv:0},{av:'subGridww_Rows',nv:0},{av:'edtavBtnrole_Title',ctrl:'vBTNROLE',prop:'Title'},{av:'edtavBtnprm_Title',ctrl:'vBTNPRM',prop:'Title'},{av:'edtavBtnsaveas_Title',ctrl:'vBTNSAVEAS',prop:'Title'},{av:'AV24FilName',fld:'vFILNAME',pic:'',nv:''},{av:'AV23FilExternalId',fld:'vFILEXTERNALID',pic:'',nv:''},{av:'AV30IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'AV27IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'AV29IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',nv:false},{av:'AV28IsAuthorized_BtnPrm',fld:'vISAUTHORIZED_BTNPRM',pic:'',nv:false},{av:'AV31IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true,nv:false},{av:'Gridwwpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDWWPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}],oparms:[{av:'subGridww_Rows',ctrl:'GRIDWW',prop:'Rows'},{av:'AV25GridWWCurrentPage',fld:'vGRIDWWCURRENTPAGE',pic:'ZZZZZZZZZ9',nv:0}]}");
         setEventMetadata("'DOADD'","{handler:'E110N1',iparms:[],oparms:[]}");
         setEventMetadata("VBTNSAVEAS.CLICK","{handler:'E170N2',iparms:[{av:'GRIDWW_nFirstRecordOnPage',nv:0},{av:'GRIDWW_nEOF',nv:0},{av:'subGridww_Rows',nv:0},{av:'edtavBtnrole_Title',ctrl:'vBTNROLE',prop:'Title'},{av:'edtavBtnprm_Title',ctrl:'vBTNPRM',prop:'Title'},{av:'edtavBtnsaveas_Title',ctrl:'vBTNSAVEAS',prop:'Title'},{av:'AV24FilName',fld:'vFILNAME',pic:'',nv:''},{av:'AV23FilExternalId',fld:'vFILEXTERNALID',pic:'',nv:''},{av:'AV30IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'AV27IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'AV29IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',nv:false},{av:'AV28IsAuthorized_BtnPrm',fld:'vISAUTHORIZED_BTNPRM',pic:'',nv:false},{av:'AV31IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true,nv:false},{av:'AV12Id',fld:'vID',pic:'ZZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'AV30IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'edtavBtnupd_Visible',ctrl:'vBTNUPD',prop:'Visible'},{av:'AV27IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'edtavBtndlt_Visible',ctrl:'vBTNDLT',prop:'Visible'},{av:'AV29IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',nv:false},{av:'edtavBtnrole_Visible',ctrl:'vBTNROLE',prop:'Visible'},{av:'AV28IsAuthorized_BtnPrm',fld:'vISAUTHORIZED_BTNPRM',pic:'',nv:false},{av:'edtavBtnprm_Visible',ctrl:'vBTNPRM',prop:'Visible'},{ctrl:'BTNADD',prop:'Visible'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV46Btnprm_GXI = "";
         AV47Btnsaveas_GXI = "";
         AV11Filter = new SdtGAMRoleFilter(context);
         AV34GAMRoles = new GXExternalCollection<SdtGAMRole>( context, "SdtGAMRole", "GeneXus.Programs");
         AV10Errors = new GXExternalCollection<SdtGAMError>( context, "SdtGAMError", "GeneXus.Programs");
         AV16Role = new SdtGAMRole(context);
         GridwwRow = new GXWebRow();
         AV15NewGAMRole = new SdtGAMRole(context);
      ...
      private long AV26GridWWPageCount ;
      private long AV12Id ;
      private long AV25GridWWCurrentPage ;
      private long GRIDWW_nCurrentRecord ;
      private long GRIDWW_nRecordCount ;
      private long AV36GridWWRecordCount ;
      ...
      private String AV23FilExternalId ;
      ...
      private String edtavBtnprm_Tooltiptext ;
      ...
      private bool AV29IsAuthorized_BtnRole ;
      private bool AV28IsAuthorized_BtnPrm ;
      ...
      private bool AV19BtnDlt_IsBlob ;
      private bool AV21BtnRole_IsBlob ;
      private bool AV20BtnPrm_IsBlob ;
      private bool AV5BtnSaveAs_IsBlob ;
      private String AV43Btnupd_GXI ;
      private String AV44Btndlt_GXI ;
      private String AV45Btnrole_GXI ;
      private String AV46Btnprm_GXI ;
      private String AV47Btnsaveas_GXI ;
      private String AV6BtnUpd ;
      private String AV19BtnDlt ;
      private String AV21BtnRole ;
      private String AV20BtnPrm ;
      ...
      private GXExternalCollection<SdtGAMRole> AV34GAMRoles ;
      private GXWebForm Form ;
      private SdtGAMError AV9Error ;
      private SdtGAMRoleFilter AV11Filter ;
      private SdtGAMRole AV16Role ;
      private SdtGAMRole AV15NewGAMRole ;
   }
