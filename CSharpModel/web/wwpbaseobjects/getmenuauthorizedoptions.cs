/*
       ...
       Generated on: 9/20/2018 19:38:42.37
   ...
   public class getmenuauthorizedoptions : GXProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         while ( AV18GXV1 <= AV9DVelop_Menu.Count )
         {
            ...
            {
               new GeneXus.Programs.wwpbaseobjects.getmenuauthorizedoptionsrecursive(context ).execute(  AV10DVelop_Menu_Item.ToJSonString(false), out  AV15ResultJson) ;
