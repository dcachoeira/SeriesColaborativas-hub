/*
               File: WWPBaseObjects.GetMenuAuthorizedOptionsRecursive
        Description: Get Menu Authorized Options Recursive
             Author: GeneXus C# Generator version 15_0_9-121631
       Generated on: 9/20/2018 19:38:45.21
   ...
   public class getmenuauthorizedoptionsrecursive : GXProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         while ( AV19GXV1 <= AV10DVelop_Menu_Item.gxTpr_Subitems.Count )
         {
            ...
            {
               new GeneXus.Programs.wwpbaseobjects.getmenuauthorizedoptionsrecursive(context ).execute(  AV9AuxDVelop_Menu_Item.ToJSonString(false), out  AV15Result2Json) ;
         ...
         AV16ResultJson = AV10DVelop_Menu_Item.ToJSonString(false);
         this.cleanup();
      }
