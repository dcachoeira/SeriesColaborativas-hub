/*!   GeneXus C# 15_0_9-121631 on 9/20/2018 19:39:39.74
*/
...
gx.define('wwpbaseobjects.promptgeolocation', false, function () {
   ...
   this.EvtParms["START"] = [[{av:'AV7Geolocation',fld:'vGEOLOCATION',pic:'',nv:''},{av:'GxMapPoint',fld:'vGXMAPPOINT',pic:'',nv:null},{av:'GxMapData',fld:'vGXMAPDATA',pic:'',nv:null}],[{av:'GxMapPoint',fld:'vGXMAPPOINT',pic:'',nv:null},{av:'GxMapData',fld:'vGXMAPDATA',pic:'',nv:null}]];
   this.EvtParms["ENTER"] = [[{av:'AV10Latitude',fld:'vLATITUDE',pic:'',nv:''},{av:'AV7Geolocation',fld:'vGEOLOCATION',pic:'',nv:''},{av:'AV11Longitude',fld:'vLONGITUDE',pic:'',nv:''}],[{av:'AV7Geolocation',fld:'vGEOLOCATION',pic:'',nv:''}]];
   this.EnterCtrl = ["BTNENTER"];
   this.setVCMap("AV10Latitude", "vLATITUDE", 0, "svchar");
   this.setVCMap("AV7Geolocation", "vGEOLOCATION", 0, "svchar");
   this.setVCMap("AV11Longitude", "vLONGITUDE", 0, "svchar");
   this.Initialize( );
});
