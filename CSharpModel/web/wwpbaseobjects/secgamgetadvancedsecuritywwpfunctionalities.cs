/*
       ...
       Generated on: 9/20/2018 19:38:30.76
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class secgamgetadvancedsecuritywwpfunctionalities : GXProcedure
   {
      ...
      {
         this.Gxm1rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtSecGAMFunctionalitiesToLoad>( context, "SecGAMFunctionalitiesToLoad", "SeriesColaborativas") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtSecGAMFunctionalitiesToLoad> aP0_Gxm1rootcol )
      {
         ...
         objsecgamgetadvancedsecuritywwpfunctionalities.Gxm1rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtSecGAMFunctionalitiesToLoad>( context, "SecGAMFunctionalitiesToLoad", "SeriesColaborativas") ;
