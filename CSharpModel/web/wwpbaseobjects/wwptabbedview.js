/*!   GeneXus C# 15_0_9-121631 on 9/20/2018 19:38:24.26
*/
...
gx.define('wwpbaseobjects.wwptabbedview', true, function (CmpContext) {
   ...
   this.TabsgridContainer = new gx.grid.grid(this, 2,"WbpLvl2",14,"Tabsgrid","Tabsgrid","TabsgridContainer",this.CmpContext,this.IsMasterPage,"wwpbaseobjects.wwptabbedview",[],true,0,true,true,0,false,false,false,"",0,"px",0,"px","Novo registro",false,false,false,null,null,false,"",false,[1,1,1,1],false,0,false,false);
   ...
   this.EvtParms["REFRESH"] = [[{av:'TABSGRID_nFirstRecordOnPage',nv:0},{av:'TABSGRID_nEOF',nv:0},{av:'sPrefix',nv:''}],[]];
