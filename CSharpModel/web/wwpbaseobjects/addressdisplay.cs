/*
       ...
       Generated on: 9/20/2018 19:39:29.34
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class addressdisplay : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?201892019392937", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"FormNoBackgroundColor\" data-gx-class=\"FormNoBackgroundColor\" novalidate action=\""+formatLink("wwpbaseobjects.addressdisplay.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV5Address)) + "," + UrlEncode(StringUtil.RTrim(AV6Geolocation))+"\">") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?201892019392949", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwpbaseobjects/addressdisplay.js", "?201892019392950", false);
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV5Address',fld:'vADDRESS',pic:'',hsh:true,nv:''},{av:'AV6Geolocation',fld:'vGEOLOCATION',pic:'',hsh:true,nv:''}],oparms:[]}");
         return  ;
      }
