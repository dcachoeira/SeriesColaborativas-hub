...
using System.IO;
public class bldseriescolaborativas : GxBaseBuilder
{
   string cs_path = "." ;
   public bldseriescolaborativas( ) : base()
   {
   }
   ...
   {
      bldseriescolaborativas x = new bldseriescolaborativas() ;
      x.SetMainSourceFile( "seriescolaborativas.cs");
   ...
   public override TargetCollection GetRuntimeBuildList( )
   {
      ...
      sc.Add( @"seriescolaborativas", "dll");
      return sc ;
   }
