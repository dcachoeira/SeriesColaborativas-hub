...
namespace GeneXus.Programs{
	...
	[XmlType(TypeName="GAMExampleSDTApplicationData" , Namespace="SeriesColaborativas" )]
	[Serializable]
	...
	[DataContract(Name=@"GAMExampleSDTApplicationData", Namespace="SeriesColaborativas")]
