...
namespace GeneXus.Programs{
	...
	[XmlType(TypeName="QueryViewerItemClickData.Element" , Namespace="SeriesColaborativas" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerItemClickData.Element", Namespace="SeriesColaborativas")]
