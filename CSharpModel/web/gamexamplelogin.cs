/*
       ...
       Generated on: 8/16/2018 20:58:18.63
...
namespace GeneXus.Programs {
   public class gamexamplelogin : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?201881620581878", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB0I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "Center", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSignin_Internalname, "LOGIN", "", "", lblSignin_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleLogin", 0, "", 1, 1, 0, "HLP_GAMExampleLogin.htm");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      protected void wb_table1_21_0I2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 CellMarginTop", "Center", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTableloginerror_Internalname, 1, 0, "px", 0, "px", "TableLoginError", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavUrl_Internalname, AV25URL, StringUtil.RTrim( context.localUtil.Format( AV25URL, "")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUrl_Jsonclick, 0, "Attribute", "", "", "", "", edtavUrl_Visible, 1, 0, "text", "", 0, "px", 1, "row", 2048, 0, 0, 0, 1, -1, 0, true, "GAMURL", "left", true, "HLP_GAMExampleLogin.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void E120I2( )
      {
         ...
         if ( StringUtil.StrCmp(AV26UserName, "admin") == 0 )
         {
         }
         else
         {
      ...
      protected void wb_table1_21_0I2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavLogonto, cmbavLogonto_Internalname, StringUtil.RTrim( AV20LogOnTo), 1, cmbavLogonto_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", cmbavLogonto.Visible, cmbavLogonto.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeLogin", "", "", TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,25);\"", "", true, "HLP_GAMExampleLogin.htm");
            cmbavLogonto.CurrentValue = StringUtil.RTrim( AV20LogOnTo);
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsername_Internalname, AV26UserName, StringUtil.RTrim( context.localUtil.Format( AV26UserName, "")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,29);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Login", edtavUsername_Jsonclick, 0, "AttributeLogin", "", "", "", "", 1, edtavUsername_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, 0, 0, true, "GAMUserIdentification", "left", true, "HLP_GAMExampleLogin.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "", "Login", bttBtnenter_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMExampleLogin.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?201881620581980", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexamplelogin.js", "?201881620581981", false);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E120I2',iparms:[{av:'cmbavLogonto'},{av:'AV20LogOnTo',fld:'vLOGONTO',pic:'',nv:''},{av:'AV26UserName',fld:'vUSERNAME',pic:'',nv:''},{av:'AV27UserPassword',fld:'vUSERPASSWORD',pic:'',nv:''},{av:'A54UsuarioLogin',fld:'USUARIOLOGIN',pic:'',nv:''},{av:'A55UsuarioSenha',fld:'USUARIOSENHA',pic:'',nv:''},{av:'A11UsuarioId',fld:'USUARIOID',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'A12UsuarioNome',fld:'USUARIONOME',pic:'',nv:''}],oparms:[{av:'AV33UsuarioSenhaMd5',fld:'vUSUARIOSENHAMD5',pic:'',nv:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gamexamplelogin__default(),
            new Object[][] {
                new Object[] {
               H000I2_A55UsuarioSenha, H000I2_A54UsuarioLogin, H000I2_A11UsuarioId, H000I2_A12UsuarioNome
               }
            }
         );
         /* GeneXus formulas. */
   ...
   public class gamexamplelogin__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000I2", "SELECT [UsuarioSenha], [UsuarioLogin], [UsuarioId], [UsuarioNome] FROM [Usuario] WITH (NOLOCK) WHERE ([UsuarioLogin] = @AV26UserName) AND ([UsuarioSenha] = @AV33UsuarioSenhaMd5) ORDER BY [UsuarioId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000I2,100,0,true,false )
          };
       }
    }
