...
namespace GeneXus.Programs{
	...
	[XmlType(TypeName="QueryViewerAxes.Axis.Format.ConditionalStyle" , Namespace="SeriesColaborativas" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerAxes.Axis.Format.ConditionalStyle", Namespace="SeriesColaborativas")]
