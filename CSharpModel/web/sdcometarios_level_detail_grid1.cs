/*
               File: SDCometarios_Level_Detail_Grid1
        Description: SDCometarios_Level_Detail_Grid1
             Author: GeneXus C# Generator version 15_0_9-121631
       Generated on: 9/27/2018 20:14:31.43
...
namespace GeneXus.Programs {
   public class sdcometarios_level_detail_grid1 : GXProcedure
   {
      public sdcometarios_level_detail_grid1( )
      {
      ...
      public sdcometarios_level_detail_grid1( IGxContext context )
      {
      ...
      public void execute( short aP0_TipoComentario ,
                           ...
                           long aP3_count ,
                           int aP4_gxid ,
                           out GXBaseCollection<SdtSDCometarios_Level_Detail_Grid1Sdt_Item> aP5_GXM3RootCol )
      {
         ...
         this.AV28GXM3RootCol = new GXBaseCollection<SdtSDCometarios_Level_Detail_Grid1Sdt_Item>( context, "Item", "") ;
         initialize();
         executePrivate();
         aP5_GXM3RootCol=this.AV28GXM3RootCol;
      }

      public GXBaseCollection<SdtSDCometarios_Level_Detail_Grid1Sdt_Item> executeUdp( short aP0_TipoComentario ,
                                                                                      long aP1_Id ,
                                                                                      long aP2_start ,
                                                                                      long aP3_count ,
                                                                                      int aP4_gxid )
      ...
      public void executeSubmit( short aP0_TipoComentario ,
                                 ...
                                 out GXBaseCollection<SdtSDCometarios_Level_Detail_Grid1Sdt_Item> aP5_GXM3RootCol )
      {
         sdcometarios_level_detail_grid1 objsdcometarios_level_detail_grid1;
         objsdcometarios_level_detail_grid1 = new sdcometarios_level_detail_grid1();
         objsdcometarios_level_detail_grid1.AV5TipoComentario = aP0_TipoComentario;
         objsdcometarios_level_detail_grid1.AV6Id = aP1_Id;
         objsdcometarios_level_detail_grid1.AV24start = aP2_start;
         objsdcometarios_level_detail_grid1.AV25count = aP3_count;
         objsdcometarios_level_detail_grid1.AV21gxid = aP4_gxid;
         objsdcometarios_level_detail_grid1.AV28GXM3RootCol = new GXBaseCollection<SdtSDCometarios_Level_Detail_Grid1Sdt_Item>( context, "Item", "") ;
         objsdcometarios_level_detail_grid1.context.SetSubmitInitialConfig(context);
         objsdcometarios_level_detail_grid1.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objsdcometarios_level_detail_grid1);
         aP5_GXM3RootCol=this.AV28GXM3RootCol;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((sdcometarios_level_detail_grid1)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         {
            AV29GXM2SDCometarios_Level_Detail_Grid1Sdt = new SdtSDCometarios_Level_Detail_Grid1Sdt_Item(context);
            if ( AV5TipoComentario == 1 )
            {
               ...
               while ( (pr_default.getStatus(0) != 101) )
               {
                  ...
                  AV29GXM2SDCometarios_Level_Detail_Grid1Sdt.gxTpr_Avaliacao = AV14Avaliacao;
                  AV29GXM2SDCometarios_Level_Detail_Grid1Sdt.gxTpr_Avaliacao_gxi = AV32Avaliacao_GXI;
                  AV29GXM2SDCometarios_Level_Detail_Grid1Sdt.gxTpr_Gxdynprop = "[ "+Gxdynprop+" ]";
                  Gxdynprop = "";
                  AV28GXM3RootCol.Add(AV29GXM2SDCometarios_Level_Detail_Grid1Sdt, 0);
                  AV29GXM2SDCometarios_Level_Detail_Grid1Sdt = new SdtSDCometarios_Level_Detail_Grid1Sdt_Item(context);
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sdcometarios_level_detail_grid1__default(),
            new Object[][] {
                new Object[] {
      ...
      private GXBaseCollection<SdtSDCometarios_Level_Detail_Grid1Sdt_Item> aP5_GXM3RootCol ;
      private IGxSession Gxwebsession ;
      private GXBaseCollection<SdtSDCometarios_Level_Detail_Grid1Sdt_Item> AV28GXM3RootCol ;
      private SdtSDCometarios_Level_Detail_Grid1Sdt_Item AV29GXM2SDCometarios_Level_Detail_Grid1Sdt ;
   }

   public class sdcometarios_level_detail_grid1__default : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 [ServiceContract(Namespace = "GeneXus.Programs.sdcometarios_level_detail_grid1_services")]
 [ServiceBehavior(ConcurrencyMode = ConcurrencyMode.Multiple)]
 [AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)]
 public class sdcometarios_level_detail_grid1_services : GxRestService
 {
    [OperationContract]
    ...
    public GxGenericCollection<SdtSDCometarios_Level_Detail_Grid1Sdt_Item_RESTInterface> execute( short TipoComentario ,
                                                                                                  String Id ,
                                                                                                  String start ,
                                                                                                  String count ,
                                                                                                  String gxid )
    {
       GxGenericCollection<SdtSDCometarios_Level_Detail_Grid1Sdt_Item_RESTInterface> GXM3RootCol = new GxGenericCollection<SdtSDCometarios_Level_Detail_Grid1Sdt_Item_RESTInterface>() ;
       try
       {
          if ( ! ProcessHeaders("sdcometarios_level_detail_grid1") )
          {
             return null ;
          }
          sdcometarios_level_detail_grid1 worker = new sdcometarios_level_detail_grid1(context) ;
          ...
          GXBaseCollection<SdtSDCometarios_Level_Detail_Grid1Sdt_Item> gxrGXM3RootCol = new GXBaseCollection<SdtSDCometarios_Level_Detail_Grid1Sdt_Item>() ;
          worker.execute(TipoComentario,gxrId,gxrstart,gxrcount,gxrgxid,out gxrGXM3RootCol );
          worker.cleanup( );
          GXM3RootCol = new GxGenericCollection<SdtSDCometarios_Level_Detail_Grid1Sdt_Item_RESTInterface>(gxrGXM3RootCol) ;
          return GXM3RootCol ;
       }
       catch ( Exception e )
       {
