...
namespace GeneXus.Programs{
	...
	[XmlType(TypeName="QueryViewerAxes.Axis.Grouping" , Namespace="SeriesColaborativas" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerAxes.Axis.Grouping", Namespace="SeriesColaborativas")]
