/*
       ...
       Generated on: 9/20/2018 19:38:16.33
...
namespace GeneXus.Programs {
   public class GxWebStd
   {
                                                  ...
                                                  String sCallerPgm )
      {
         ...
         if ( nEnabled == 0 )
         {
            ...
            if ( nFormat != 2 )
            {
               ...
               GxWebStd.gx_start_js_anchor_wml( context, nJScriptCode, sEventJsCode, sUserOnClickCode, sLinkURL, sLinkTarget, "");
            }
            if ( nIsPassword == 0 )
            {
               if ( nFormat == 0 )
                                             ...
                                             String sCallerPgm )
      {
         ...
         context.WriteHtmlText( sTags) ;
         context.WriteHtmlText( GXUtil.HtmlEndTag( HTMLElement.INPUT)) ;
         GxWebStd.gx_ctrl_attribute_wml( context, sCtrlName, "data-jsevent", sUserOnClickCode, false);
         if ( StringUtil.StrCmp(sBorderStyle, "rounded") == 0 )
         {
            context.WriteHtmlText( "</span></span></span></span>") ;
         }
      ...
      static public void gx_combobox_ctrl_wml( IGxContext context ,
                                               ...
                                               String sCallerPgm )
      {
         gx_combobox_ctrl1_wml( context, cmbCObjCtrl, sCtrlName, sValue, nRows, sUserOnClickCode, nJScriptCode, sEventName, sType, sTooltipText, nVisible, nEnabled, nRTEnabled, nFormat, nWidth, nWidthUnit, nHeight, nHeightUnit, sStyleString, sClassString, sColumnClassString, sColumnHeaderClassString, sTags, sFormatedValue, true, sCallerPgm) ;
      }
                                                ...
                                                String sCallerPgm )
      {
         ...
         context.WriteHtmlTextNl( "</select>") ;
         GxWebStd.gx_ctrl_attribute_wml( context, sCtrlName, "data-jsevent", sUserOnClickCode, false);
         GxWebStd.gx_ctrl_attribute_wml( context, sCtrlName, "data-gxoch0", sEventJsCode, true);
         if ( nEnabled == 0 )
         {
            if ( ( StringUtil.Len( sClassString) != 0 ) && ( StringUtil.StringSearch( sClassString, "Readonly", 1) != 1 ) )
            {
      ...
      static public void gx_listbox_ctrl_wml( IGxContext context ,
                                              ...
                                              String sCallerPgm )
      {
         gx_listbox_ctrl1_wml( context, lstLObjCtrl, sCtrlName, sValue, nRows, sUserOnClickCode, nJScriptCode, sEventName, sType, sTooltipText, nVisible, nEnabled, nRTEnabled, nFormat, nWidth, nWidthUnit, nHeight, nHeightUnit, sStyleString, sClassString, sColumnClassString, sColumnHeaderClassString, sTags, sFormatedValue, true, sCallerPgm) ;
      }
                                                 ...
                                                 String sImgSrcSet )
      {
         ...
         if ( ( nEnabled != 0 ) && ( StringUtil.StrCmp(sLinkURL, "") != 0 ) )
         {
            GxWebStd.gx_start_js_anchor_wml( context, nJScriptCode, sEventJsCode, sUserOnClickCode, sLinkURL, sLinkTarget, "gx-image-link");
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( sImageURL)) )
         {
            context.WriteHtmlText( "<img src=\""+context.convertURL( sImageURL)+"\"") ;
                                                       ...
                                                       String sCallerPgm )
      {
         ...
         GxWebStd.gx_single_line_edit_wml( context, sInternalName+"_GXI", sURL, sURL, sInputTags, sEventName, "", "", sTooltipText, "", sUserOnClickCode, 0, "field "+sClassString, sStyleString, "", "", "", 1, 1, 1, "text", "", nWidth, nWidthUnit, nHeight, nHeightUnit, 254, 0, 2, 0, 1, 1, 0, true, "", sAlign, false, sCallerPgm);
         context.WriteHtmlText( "<input type=\"file\" class=\"field ") ;
         context.SendWebValue( sClassString) ;
         context.WriteHtmlText( "\"") ;
         context.WriteHtmlText( " id=\"") ;
                                            ...
                                            String sCallerPgm )
      {
         ...
         if ( ( nFormat != 0 ) && ( nFormat != 2 ) )
         {
            GxWebStd.gx_ctrl_attribute_wml( context, sInternalName, "data-gxformat", StringUtil.Str( (decimal)(nFormat), 1, 0), false);
         }
         if ( ( nFormat == 1 ) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( sEventJsCode)) || ! String.IsNullOrEmpty(StringUtil.RTrim( sUserOnClickCode)) || ! String.IsNullOrEmpty(StringUtil.RTrim( sLinkURL)) ) )
         {
                                                 ...
                                                 String sClassString )
      {
         ...
         else
         {
            ...
            {
               GxWebStd.gx_link_start_wml( context, sLinkURL, sLinkTarget, sClassString);
            }
         }
      }
      ...
      static public void gx_label_element_wml( IGxContext context ,
                                               String sReferencedControl ,
                                               String sLabelCaption ,
                                               String sLabelClass ,
                                               int nLabelPosition ,
                                               ...
                                               String sCallerPgm )
      {
         ...
         if ( nEnabled == 0 )
         {
            ...
            GxWebStd.gx_start_js_anchor_wml( context, nJScriptCode, sEventJsCode, "", sLinkURL, sLinkTarget, "");
            if ( nFormat == 0 )
            {
               context.SendWebValueEnter( sValue) ;
            }
            ...
            GxWebStd.gx_end_js_anchor_wml( context, sEventJsCode, "", sLinkURL);
         }
      }
      ...
      static public void gx_div_end_wml( IGxContext context ,
                                         String sAlign ,
                                         String sVAlign ,
                                         String sHtmlTag )
      {
      ...
      static public void gx_form_group_start_wml( IGxContext context ,
                                                  int nLabelPosition )
      {
         if ( nLabelPosition != 0 )
         {
      ...
      static public void gx_form_group_end_wml( IGxContext context ,
                                                int nLabelPosition )
      {
         if ( nLabelPosition != 0 )
         {
