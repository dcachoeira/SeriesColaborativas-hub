/*
               File: SDComentarios_Level_Detail_Grid2
        Description: SDComentarios_Level_Detail_Grid2
             Author: GeneXus C# Generator version 15_0_9-121631
       Generated on: 10/1/2018 14:32:6.44
...
namespace GeneXus.Programs {
   public class sdcomentarios_level_detail_grid2 : GXProcedure
   {
      public sdcomentarios_level_detail_grid2( )
      {
      ...
      public sdcomentarios_level_detail_grid2( IGxContext context )
      {
      ...
      public void execute( short aP0_TipoComentario ,
                           ...
                           long aP3_count ,
                           int aP4_gxid ,
                           out GXBaseCollection<SdtSDComentarios_Level_Detail_Grid2Sdt_Item> aP5_GXM3RootCol )
      {
         ...
         this.AV27GXM3RootCol = new GXBaseCollection<SdtSDComentarios_Level_Detail_Grid2Sdt_Item>( context, "Item", "") ;
         initialize();
         executePrivate();
         aP5_GXM3RootCol=this.AV27GXM3RootCol;
      }

      public GXBaseCollection<SdtSDComentarios_Level_Detail_Grid2Sdt_Item> executeUdp( short aP0_TipoComentario ,
                                                                                       long aP1_Id ,
                                                                                       long aP2_start ,
                                                                                       long aP3_count ,
                                                                                       int aP4_gxid )
      ...
      public void executeSubmit( short aP0_TipoComentario ,
                                 ...
                                 out GXBaseCollection<SdtSDComentarios_Level_Detail_Grid2Sdt_Item> aP5_GXM3RootCol )
      {
         sdcomentarios_level_detail_grid2 objsdcomentarios_level_detail_grid2;
         objsdcomentarios_level_detail_grid2 = new sdcomentarios_level_detail_grid2();
         objsdcomentarios_level_detail_grid2.AV5TipoComentario = aP0_TipoComentario;
         objsdcomentarios_level_detail_grid2.AV6Id = aP1_Id;
         objsdcomentarios_level_detail_grid2.AV24start = aP2_start;
         objsdcomentarios_level_detail_grid2.AV25count = aP3_count;
         objsdcomentarios_level_detail_grid2.AV21gxid = aP4_gxid;
         objsdcomentarios_level_detail_grid2.AV27GXM3RootCol = new GXBaseCollection<SdtSDComentarios_Level_Detail_Grid2Sdt_Item>( context, "Item", "") ;
         objsdcomentarios_level_detail_grid2.context.SetSubmitInitialConfig(context);
         objsdcomentarios_level_detail_grid2.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objsdcomentarios_level_detail_grid2);
         aP5_GXM3RootCol=this.AV27GXM3RootCol;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((sdcomentarios_level_detail_grid2)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         {
            AV28GXM2SDComentarios_Level_Detail_Grid2Sdt = new SdtSDComentarios_Level_Detail_Grid2Sdt_Item(context);
            ...
            AV28GXM2SDComentarios_Level_Detail_Grid2Sdt.gxTpr_Um = AV15Um;
            AV28GXM2SDComentarios_Level_Detail_Grid2Sdt.gxTpr_Um_gxi = AV31Um_GXI;
            AV28GXM2SDComentarios_Level_Detail_Grid2Sdt.gxTpr_Dois = AV16Dois;
            AV28GXM2SDComentarios_Level_Detail_Grid2Sdt.gxTpr_Dois_gxi = AV32Dois_GXI;
            AV28GXM2SDComentarios_Level_Detail_Grid2Sdt.gxTpr_Tres = AV17Tres;
            AV28GXM2SDComentarios_Level_Detail_Grid2Sdt.gxTpr_Tres_gxi = AV33Tres_GXI;
            AV28GXM2SDComentarios_Level_Detail_Grid2Sdt.gxTpr_Quatro = AV18Quatro;
            AV28GXM2SDComentarios_Level_Detail_Grid2Sdt.gxTpr_Quatro_gxi = AV34Quatro_GXI;
            AV28GXM2SDComentarios_Level_Detail_Grid2Sdt.gxTpr_Cinco = AV19Cinco;
            AV28GXM2SDComentarios_Level_Detail_Grid2Sdt.gxTpr_Cinco_gxi = AV35Cinco_GXI;
            AV27GXM3RootCol.Add(AV28GXM2SDComentarios_Level_Detail_Grid2Sdt, 0);
            AV28GXM2SDComentarios_Level_Detail_Grid2Sdt = new SdtSDComentarios_Level_Detail_Grid2Sdt_Item(context);
            AV28GXM2SDComentarios_Level_Detail_Grid2Sdt.gxTpr_Um = AV15Um;
            AV28GXM2SDComentarios_Level_Detail_Grid2Sdt.gxTpr_Um_gxi = AV31Um_GXI;
            AV28GXM2SDComentarios_Level_Detail_Grid2Sdt.gxTpr_Dois = AV16Dois;
      ...
      private GXBaseCollection<SdtSDComentarios_Level_Detail_Grid2Sdt_Item> aP5_GXM3RootCol ;
      private IGxSession Gxwebsession ;
      private GXBaseCollection<SdtSDComentarios_Level_Detail_Grid2Sdt_Item> AV27GXM3RootCol ;
      private SdtSDComentarios_Level_Detail_Grid2Sdt_Item AV28GXM2SDComentarios_Level_Detail_Grid2Sdt ;
   }

   [ServiceContract(Namespace = "GeneXus.Programs.sdcomentarios_level_detail_grid2_services")]
   [ServiceBehavior(ConcurrencyMode = ConcurrencyMode.Multiple)]
   [AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)]
   public class sdcomentarios_level_detail_grid2_services : GxRestService
   {
      [OperationContract]
      ...
      public GxGenericCollection<SdtSDComentarios_Level_Detail_Grid2Sdt_Item_RESTInterface> execute( short TipoComentario ,
                                                                                                     String Id ,
                                                                                                     String start ,
                                                                                                     String count ,
                                                                                                     String gxid )
      {
         GxGenericCollection<SdtSDComentarios_Level_Detail_Grid2Sdt_Item_RESTInterface> GXM3RootCol = new GxGenericCollection<SdtSDComentarios_Level_Detail_Grid2Sdt_Item_RESTInterface>() ;
         try
         {
            if ( ! ProcessHeaders("sdcomentarios_level_detail_grid2") )
            {
               return null ;
            }
            sdcomentarios_level_detail_grid2 worker = new sdcomentarios_level_detail_grid2(context) ;
            ...
            GXBaseCollection<SdtSDComentarios_Level_Detail_Grid2Sdt_Item> gxrGXM3RootCol = new GXBaseCollection<SdtSDComentarios_Level_Detail_Grid2Sdt_Item>() ;
            worker.execute(TipoComentario,gxrId,gxrstart,gxrcount,gxrgxid,out gxrGXM3RootCol );
            worker.cleanup( );
            GXM3RootCol = new GxGenericCollection<SdtSDComentarios_Level_Detail_Grid2Sdt_Item_RESTInterface>(gxrGXM3RootCol) ;
            return GXM3RootCol ;
         }
         catch ( Exception e )
         {
