/*
               File: GAMWWSecurityPolicy
        Description: Security policies
             Author: GeneXus C# Generator version 15_0_9-121631
       Generated on: 9/20/2018 19:41:1.12
...
namespace GeneXus.Programs {
   public class gamwwsecuritypolicy : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxNewRow_"+"Gridww") == 0 )
            {
               ...
               context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnsaveas_Internalname, "Title", edtavBtnsaveas_Title, !bGXsfl_38_Refreshing);
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Gridww") == 0 )
            {
               ...
               edtavBtnsaveas_Title = GetNextPar( );
               context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnsaveas_Internalname, "Title", edtavBtnsaveas_Title, !bGXsfl_38_Refreshing);
               AV18FilName = GetNextPar( );
               AV22IsAuthorized_BtnUpd = (bool)(BooleanUtil.Val(GetNextPar( )));
               AV21IsAuthorized_BtnDlt = (bool)(BooleanUtil.Val(GetNextPar( )));
               ...
               gxgrGridww_refresh( subGridww_Rows, AV18FilName, AV22IsAuthorized_BtnUpd, AV21IsAuthorized_BtnDlt, AV23IsAuthorized_Name) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20189201941176", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gamwwsecuritypolicy.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vGRIDWWPAGECOUNT", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV20GridWWPageCount), 10, 0, ",", "")));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_BTNUPD", AV22IsAuthorized_BtnUpd);
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_BTNDLT", AV21IsAuthorized_BtnDlt);
      ...
      protected void WB0Q0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnadd_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(38), 2, 0)+","+"null"+");", "Insert", bttBtnadd_Jsonclick, 7, "Add children", "", StyleString, ClassString, bttBtnadd_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"e110q1_client"+"'", TempTags, "", 2, "HLP_GAMWWSecurityPolicy.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            wb_table1_27_0Q2( true) ;
         }
         else
         {
            wb_table1_27_0Q2( false) ;
         }
         return  ;
      }

      protected void wb_table1_27_0Q2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            else
            {
               ...
               GridwwColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridwwColumn.AddObjectProperty("Value", context.convertURL( AV16BtnDlt));
         ...
         if ( wbEnd == 38 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavGridwwcurrentpage_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV19GridWWCurrentPage), 10, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV19GridWWCurrentPage), "ZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,48);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavGridwwcurrentpage_Jsonclick, 0, "Attribute", "", "", "", "", edtavGridwwcurrentpage_Visible, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_GAMWWSecurityPolicy.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 11), "GRIDWW.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 16), "VBTNSAVEAS.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 16), "VBTNSAVEAS.CLICK") == 0 ) )
                           {
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnupd_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV6BtnUpd)) ? AV35Btnupd_GXI : context.convertURL( context.PathToRelativeUrl( AV6BtnUpd))), !bGXsfl_38_Refreshing);
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnupd_Internalname, "SrcSet", context.GetImageSrcSet( AV6BtnUpd), true);
                              AV16BtnDlt = cgiGet( edtavBtndlt_Internalname);
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtndlt_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV16BtnDlt)) ? AV36Btndlt_GXI : context.convertURL( context.PathToRelativeUrl( AV16BtnDlt))), !bGXsfl_38_Refreshing);
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtndlt_Internalname, "SrcSet", context.GetImageSrcSet( AV16BtnDlt), true);
                              AV5BtnSaveAs = cgiGet( edtavBtnsaveas_Internalname);
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnsaveas_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV5BtnSaveAs)) ? AV37Btnsaveas_GXI : context.convertURL( context.PathToRelativeUrl( AV5BtnSaveAs))), !bGXsfl_38_Refreshing);
                              ...
                              if ( ( ( context.localUtil.CToN( cgiGet( edtavId_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavId_Internalname), ",", ".") > Convert.ToDecimal( 999999999999L )) ) )
                              {
                                 ...
                                 context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vID"+"_"+sGXsfl_38_idx, GetSecureSignedToken( sGXsfl_38_idx, context.localUtil.Format( (decimal)(AV10Id), "ZZZZZZZZZZZ9"), context));
                              }
                              else
                              {
      ...
      protected void gxgrGridww_refresh( int subGridww_Rows ,
                                         String AV18FilName ,
                                         bool AV22IsAuthorized_BtnUpd ,
                                         bool AV21IsAuthorized_BtnDlt ,
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10Id), "ZZZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10Id), 12, 0, ".", "")));
      }
      ...
      protected void send_integrity_lvl_hashes0Q2( )
      {
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_NAME", AV23IsAuthorized_Name);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_NAME", GetSecureSignedToken( "", AV23IsAuthorized_Name, context));
         GxWebStd.gx_hidden_field( context, "gxhash_vID"+"_"+sGXsfl_38_idx, GetSecureSignedToken( sGXsfl_38_idx, context.localUtil.Format( (decimal)(AV10Id), "ZZZZZZZZZZZ9"), context));
      }
      ...
      protected void STRUP0Q0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV18FilName", AV18FilName);
            if ( ( ( context.localUtil.CToN( cgiGet( edtavGridwwcurrentpage_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavGridwwcurrentpage_Internalname), ",", ".") > Convert.ToDecimal( 9999999999L )) ) )
            {
               ...
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV19GridWWCurrentPage = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV19GridWWCurrentPage", StringUtil.LTrim( StringUtil.Str( (decimal)(AV19GridWWCurrentPage), 10, 0)));
            }
            else
            {
               AV19GridWWCurrentPage = (long)(context.localUtil.CToN( cgiGet( edtavGridwwcurrentpage_Internalname), ",", "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV19GridWWCurrentPage", StringUtil.LTrim( StringUtil.Str( (decimal)(AV19GridWWCurrentPage), 10, 0)));
            }
            /* Read saved values. */
            nRC_GXsfl_38 = (short)(context.localUtil.CToN( cgiGet( "nRC_GXsfl_38"), ",", "."));
            AV20GridWWPageCount = (long)(context.localUtil.CToN( cgiGet( "vGRIDWWPAGECOUNT"), ",", "."));
      ...
      protected void E140Q2( )
      {
         ...
         AV20GridWWPageCount = -1;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV20GridWWPageCount", StringUtil.LTrim( StringUtil.Str( (decimal)(AV20GridWWPageCount), 10, 0)));
      ...
      {
         /* Gridww_Load Routine */
         AV9Filter.gxTpr_Name = "%"+AV18FilName;
         AV26GAMSecurityPolicies = new SdtGAMRepository(context).getsecuritypolicies(AV9Filter, out  AV8Errors);
         AV28GridWWRecordCount = AV26GAMSecurityPolicies.Count;
         AV27GridWWPageSize = 9;
         if ( AV26GAMSecurityPolicies.Count == 0 )
         {
            AV20GridWWPageCount = 0;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV20GridWWPageCount", StringUtil.LTrim( StringUtil.Str( (decimal)(AV20GridWWPageCount), 10, 0)));
         }
         else
         {
            AV20GridWWPageCount = (long)((AV26GAMSecurityPolicies.Count/ (decimal)(9))+1);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV20GridWWPageCount", StringUtil.LTrim( StringUtil.Str( (decimal)(AV20GridWWPageCount), 10, 0)));
         }
         AV34GXV1 = 1;
         while ( AV34GXV1 <= AV26GAMSecurityPolicies.Count )
         {
            AV15SecurityPolicy = ((SdtGAMSecurityPolicy)AV26GAMSecurityPolicies.Item(AV34GXV1));
            ...
            AV35Btnupd_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7c63c2b9-483e-4035-b512-febf9186a274", "", context.GetTheme( )));
            edtavBtnupd_Tooltiptext = "";
            if ( AV22IsAuthorized_BtnUpd )
            {
               edtavBtnupd_Link = formatLink("gamsecuritypolicyentry.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +AV10Id);
            }
            AV16BtnDlt = context.GetImagePath( "7695fe89-52c9-4b7e-871e-0e11548f823e", "", context.GetTheme( ));
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, edtavBtndlt_Internalname, AV16BtnDlt);
            ...
            if ( AV21IsAuthorized_BtnDlt )
            {
               edtavBtndlt_Link = formatLink("gamsecuritypolicyentry.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +AV10Id);
            }
            ...
            AV37Btnsaveas_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7f618bea-47cd-4ba5-84d7-c430500a42e3", "", context.GetTheme( )));
            edtavBtnsaveas_Tooltiptext = "Copy";
            if ( AV23IsAuthorized_Name )
            {
               edtavName_Link = formatLink("gamsecuritypolicyentry.aspx") + "?" + UrlEncode(StringUtil.RTrim("DSP")) + "," + UrlEncode("" +AV10Id);
            }
            /* Load Method */
            if ( wbStart != -1 )
            {
      ...
      protected void E120Q2( )
      {
         ...
         {
            AV19GridWWCurrentPage = (long)(AV19GridWWCurrentPage-1);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV19GridWWCurrentPage", StringUtil.LTrim( StringUtil.Str( (decimal)(AV19GridWWCurrentPage), 10, 0)));
         ...
         else
         {
            ...
            AV19GridWWCurrentPage = AV24PageToGo;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV19GridWWCurrentPage", StringUtil.LTrim( StringUtil.Str( (decimal)(AV19GridWWCurrentPage), 10, 0)));
      ...
      protected void S112( )
      {
         ...
         GXt_boolean1 = AV22IsAuthorized_BtnUpd;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "gamsecuritypolicyentry_Execute", out  GXt_boolean1) ;
         AV22IsAuthorized_BtnUpd = GXt_boolean1;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV22IsAuthorized_BtnUpd", AV22IsAuthorized_BtnUpd);
         if ( ! ( AV22IsAuthorized_BtnUpd ) )
         {
         ...
         GXt_boolean1 = AV21IsAuthorized_BtnDlt;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "gamsecuritypolicyentry_Execute", out  GXt_boolean1) ;
         AV21IsAuthorized_BtnDlt = GXt_boolean1;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV21IsAuthorized_BtnDlt", AV21IsAuthorized_BtnDlt);
         if ( ! ( AV21IsAuthorized_BtnDlt ) )
         {
      ...
      protected void E170Q2( )
      {
         ...
         if ( AV11isOK )
         {
            pr_gam.commit( "GAMWWSecurityPolicy");
            pr_default.commit( "GAMWWSecurityPolicy");
            context.DoAjaxRefresh();
         }
         else
         {
            AV38GXV2 = 1;
            while ( AV38GXV2 <= AV8Errors.Count )
            {
               AV7Error = ((SdtGAMError)AV8Errors.Item(AV38GXV2));
      ...
      protected void wb_table1_27_0Q2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilname_Internalname, StringUtil.RTrim( AV18FilName), StringUtil.RTrim( context.localUtil.Format( AV18FilName, "")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,32);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFilname_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilname_Enabled, 0, "text", "", 80, "chr", 1, "row", 254, 0, 0, 0, 1, -1, -1, true, "GAMDescriptionLong", "left", true, "HLP_GAMWWSecurityPolicy.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_27_0Q2e( true) ;
         }
         else
         {
            wb_table1_27_0Q2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20189201941924", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("gamwwsecuritypolicy.js", "?20189201941928", false);
      ...
      protected void sendrow_382( )
      {
         ...
         if ( ( subGridww_Rows * 1 == 0 ) || ( nGXsfl_38_idx <= subGridww_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV6BtnUpd_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV6BtnUpd))&&String.IsNullOrEmpty(StringUtil.RTrim( AV35Btnupd_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV6BtnUpd)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV6BtnUpd)) ? AV35Btnupd_GXI : context.PathToRelativeUrl( AV6BtnUpd));
            ...
            StyleString = "";
            AV16BtnDlt_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV16BtnDlt))&&String.IsNullOrEmpty(StringUtil.RTrim( AV36Btndlt_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV16BtnDlt)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV16BtnDlt)) ? AV36Btndlt_GXI : context.PathToRelativeUrl( AV16BtnDlt));
            GridwwRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(String)edtavBtndlt_Internalname,(String)sImgUrl,(String)edtavBtndlt_Link,(String)"",(String)"",context.GetTheme( ),(int)edtavBtndlt_Visible,(short)1,(String)"",(String)edtavBtndlt_Tooltiptext,(short)0,(short)-1,(short)0,(String)"px",(short)0,(String)"px",(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)"WWActionColumn",(String)"",(String)"",(String)"",(String)"",(String)"",(String)"",(short)1,(bool)AV16BtnDlt_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridwwContainer.GetWrapped() == 1 )
            {
            ...
            TempTags = " " + ((edtavBtnsaveas_Enabled!=0)&&(edtavBtnsaveas_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 41,'',false,'',38)\"" : " ");
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV5BtnSaveAs_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV5BtnSaveAs))&&String.IsNullOrEmpty(StringUtil.RTrim( AV37Btnsaveas_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV5BtnSaveAs)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV5BtnSaveAs)) ? AV37Btnsaveas_GXI : context.PathToRelativeUrl( AV5BtnSaveAs));
            GridwwRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(String)edtavBtnsaveas_Internalname,(String)sImgUrl,(String)"",(String)"",(String)"",context.GetTheme( ),(short)-1,(short)1,(String)"",(String)edtavBtnsaveas_Tooltiptext,(short)0,(short)-1,(short)0,(String)"px",(short)0,(String)"px",(short)0,(short)0,(short)5,(String)edtavBtnsaveas_Jsonclick,"'"+""+"'"+",false,"+"'"+"EVBTNSAVEAS.CLICK."+sGXsfl_38_idx+"'",(String)StyleString,(String)ClassString,(String)"WWActionColumn hidden-xs",(String)"",(String)"",(String)"",(String)""+TempTags,(String)"",(String)"",(short)1,(bool)AV5BtnSaveAs_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridwwContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            TempTags = " " + ((edtavName_Enabled!=0)&&(edtavName_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 42,'',false,'"+sGXsfl_38_idx+"',38)\"" : " ");
            ...
            ROClassString = "Attribute";
            GridwwRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtavId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10Id), 12, 0, ",", "")),((edtavId_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10Id), "ZZZZZZZZZZZ9")) : context.localUtil.Format( (decimal)(AV10Id), "ZZZZZZZZZZZ9")),TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+((edtavId_Enabled!=0)&&(edtavId_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,43);\"" : " "),(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtavId_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn",(String)"",(short)0,(int)edtavId_Enabled,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)12,(short)0,(short)0,(short)38,(short)1,(short)-1,(short)0,(bool)true,(String)"GAMKeyNumLong",(String)"right",(bool)false});
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRIDWW_nFirstRecordOnPage',nv:0},{av:'GRIDWW_nEOF',nv:0},{av:'subGridww_Rows',nv:0},{av:'edtavBtnsaveas_Title',ctrl:'vBTNSAVEAS',prop:'Title'},{av:'AV18FilName',fld:'vFILNAME',pic:'',nv:''},{av:'AV22IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'AV21IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'AV23IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true,nv:false}],oparms:[{av:'AV22IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'edtavBtnupd_Visible',ctrl:'vBTNUPD',prop:'Visible'},{av:'AV21IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'edtavBtndlt_Visible',ctrl:'vBTNDLT',prop:'Visible'},{ctrl:'BTNADD',prop:'Visible'}]}");
         setEventMetadata("GRIDWW.LOAD","{handler:'E160Q2',iparms:[{av:'AV18FilName',fld:'vFILNAME',pic:'',nv:''},{av:'AV22IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'AV21IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'AV23IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true,nv:false}],oparms:[{av:'AV20GridWWPageCount',fld:'vGRIDWWPAGECOUNT',pic:'ZZZZZZZZZ9',nv:0},{av:'AV10Id',fld:'vID',pic:'ZZZZZZZZZZZ9',hsh:true,nv:0},{av:'AV12Name',fld:'vNAME',pic:'',nv:''},{av:'AV6BtnUpd',fld:'vBTNUPD',pic:'',nv:''},{av:'edtavBtnupd_Tooltiptext',ctrl:'vBTNUPD',prop:'Tooltiptext'},{av:'edtavBtnupd_Link',ctrl:'vBTNUPD',prop:'Link'},{av:'AV16BtnDlt',fld:'vBTNDLT',pic:'',nv:''},{av:'edtavBtndlt_Tooltiptext',ctrl:'vBTNDLT',prop:'Tooltiptext'},{av:'edtavBtndlt_Link',ctrl:'vBTNDLT',prop:'Link'},{av:'AV5BtnSaveAs',fld:'vBTNSAVEAS',pic:'',nv:''},{av:'edtavBtnsaveas_Tooltiptext',ctrl:'vBTNSAVEAS',prop:'Tooltiptext'},{av:'edtavName_Link',ctrl:'vNAME',prop:'Link'}]}");
         setEventMetadata("GRIDWWPAGINATIONBAR.CHANGEPAGE","{handler:'E120Q2',iparms:[{av:'GRIDWW_nFirstRecordOnPage',nv:0},{av:'GRIDWW_nEOF',nv:0},{av:'subGridww_Rows',nv:0},{av:'edtavBtnsaveas_Title',ctrl:'vBTNSAVEAS',prop:'Title'},{av:'AV18FilName',fld:'vFILNAME',pic:'',nv:''},{av:'AV22IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'AV21IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'AV23IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true,nv:false},{av:'Gridwwpaginationbar_Selectedpage',ctrl:'GRIDWWPAGINATIONBAR',prop:'SelectedPage'},{av:'AV19GridWWCurrentPage',fld:'vGRIDWWCURRENTPAGE',pic:'ZZZZZZZZZ9',nv:0}],oparms:[{av:'AV19GridWWCurrentPage',fld:'vGRIDWWCURRENTPAGE',pic:'ZZZZZZZZZ9',nv:0},{av:'AV22IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'edtavBtnupd_Visible',ctrl:'vBTNUPD',prop:'Visible'},{av:'AV21IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'edtavBtndlt_Visible',ctrl:'vBTNDLT',prop:'Visible'},{ctrl:'BTNADD',prop:'Visible'}]}");
         setEventMetadata("GRIDWWPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E130Q2',iparms:[{av:'GRIDWW_nFirstRecordOnPage',nv:0},{av:'GRIDWW_nEOF',nv:0},{av:'subGridww_Rows',nv:0},{av:'edtavBtnsaveas_Title',ctrl:'vBTNSAVEAS',prop:'Title'},{av:'AV18FilName',fld:'vFILNAME',pic:'',nv:''},{av:'AV22IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'AV21IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'AV23IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true,nv:false},{av:'Gridwwpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDWWPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}],oparms:[{av:'subGridww_Rows',ctrl:'GRIDWW',prop:'Rows'},{av:'AV19GridWWCurrentPage',fld:'vGRIDWWCURRENTPAGE',pic:'ZZZZZZZZZ9',nv:0}]}");
         setEventMetadata("'DOADD'","{handler:'E110Q1',iparms:[],oparms:[]}");
         setEventMetadata("VBTNSAVEAS.CLICK","{handler:'E170Q2',iparms:[{av:'GRIDWW_nFirstRecordOnPage',nv:0},{av:'GRIDWW_nEOF',nv:0},{av:'subGridww_Rows',nv:0},{av:'edtavBtnsaveas_Title',ctrl:'vBTNSAVEAS',prop:'Title'},{av:'AV18FilName',fld:'vFILNAME',pic:'',nv:''},{av:'AV22IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'AV21IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'AV23IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true,nv:false},{av:'AV10Id',fld:'vID',pic:'ZZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'AV22IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'edtavBtnupd_Visible',ctrl:'vBTNUPD',prop:'Visible'},{av:'AV21IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'edtavBtndlt_Visible',ctrl:'vBTNDLT',prop:'Visible'},{ctrl:'BTNADD',prop:'Visible'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV26GAMSecurityPolicies = new GXExternalCollection<SdtGAMSecurityPolicy>( context, "SdtGAMSecurityPolicy", "GeneXus.Programs");
         AV8Errors = new GXExternalCollection<SdtGAMError>( context, "SdtGAMError", "GeneXus.Programs");
         AV15SecurityPolicy = new SdtGAMSecurityPolicy(context);
         GridwwRow = new GXWebRow();
         AV13NewGAMSecurityPolicy = new SdtGAMSecurityPolicy(context);
      ...
      private long AV20GridWWPageCount ;
      private long AV10Id ;
      private long AV19GridWWCurrentPage ;
      private long GRIDWW_nCurrentRecord ;
      private long GRIDWW_nRecordCount ;
      private long AV28GridWWRecordCount ;
      private long AV27GridWWPageSize ;
      ...
      private bool AV22IsAuthorized_BtnUpd ;
      private bool AV21IsAuthorized_BtnDlt ;
      ...
      private bool AV16BtnDlt_IsBlob ;
      private bool AV5BtnSaveAs_IsBlob ;
      private String AV35Btnupd_GXI ;
      private String AV36Btndlt_GXI ;
      private String AV37Btnsaveas_GXI ;
      private String AV6BtnUpd ;
      private String AV16BtnDlt ;
      ...
      private GXExternalCollection<SdtGAMSecurityPolicy> AV26GAMSecurityPolicies ;
      private GXWebForm Form ;
      private SdtGAMError AV7Error ;
      private SdtGAMSecurityPolicyFilter AV9Filter ;
      private SdtGAMSecurityPolicy AV15SecurityPolicy ;
      private SdtGAMSecurityPolicy AV13NewGAMSecurityPolicy ;
   }
