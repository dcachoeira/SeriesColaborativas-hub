/*
               File: GAMWWRepositories
        Description: Repositories
             Author: GeneXus C# Generator version 15_0_9-121631
       Generated on: 9/20/2018 19:41:53.60
...
namespace GeneXus.Programs {
   public class gamwwrepositories : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Gridww") == 0 )
            {
               ...
               AV18IsAuthorized_BtnUpd = (bool)(BooleanUtil.Val(GetNextPar( )));
               AV19IsAuthorized_BtnDlt = (bool)(BooleanUtil.Val(GetNextPar( )));
               AV21IsAuthorized_Id = (bool)(BooleanUtil.Val(GetNextPar( )));
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
               ...
               gxgrGridww_refresh( subGridww_Rows, AV17FilName, AV18IsAuthorized_BtnUpd, AV19IsAuthorized_BtnDlt, AV21IsAuthorized_Id) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?201892019415418", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gamwwrepositories.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_BTNUPD", AV18IsAuthorized_BtnUpd);
      ...
      protected void WB0W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnadd_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(38), 2, 0)+","+"null"+");", "Insert", bttBtnadd_Jsonclick, 7, "Insert", "", StyleString, ClassString, bttBtnadd_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"e110w1_client"+"'", TempTags, "", 2, "HLP_GAMWWRepositories.htm");
            ...
            wb_table1_24_0W2( true) ;
         }
         else
         {
            wb_table1_24_0W2( false) ;
         }
         return  ;
      }

      protected void wb_table1_24_0W2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            else
            {
               ...
               GridwwColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridwwColumn.AddObjectProperty("Value", context.convertURL( AV5BtnDlt));
               ...
               GridwwColumn.AddObjectProperty("Link", StringUtil.RTrim( edtavId_Link));
               GridwwContainer.AddColumnProperties(GridwwColumn);
               GridwwColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         ...
         if ( wbEnd == 38 )
         {
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 47,'',false,'" + sGXsfl_38_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavGridwwcurrentpage_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV24GridWWCurrentPage), 10, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV24GridWWCurrentPage), "ZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,47);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavGridwwcurrentpage_Jsonclick, 0, "Attribute", "", "", "", "", edtavGridwwcurrentpage_Visible, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_GAMWWRepositories.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 11), "GRIDWW.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtnupd_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV6BtnUpd)) ? AV34Btnupd_GXI : context.convertURL( context.PathToRelativeUrl( AV6BtnUpd))), !bGXsfl_38_Refreshing);
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtndlt_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV5BtnDlt)) ? AV35Btndlt_GXI : context.convertURL( context.PathToRelativeUrl( AV5BtnDlt))), !bGXsfl_38_Refreshing);
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBtndlt_Internalname, "SrcSet", context.GetImageSrcSet( AV5BtnDlt), true);
                              AV11Id = (long)(context.localUtil.CToN( cgiGet( edtavId_Internalname), ",", "."));
                              context.httpAjaxContext.ajax_rsp_assign_attri("", false, edtavId_Internalname, StringUtil.LTrim( StringUtil.Str( (decimal)(AV11Id), 12, 0)));
                              AV13Name = cgiGet( edtavName_Internalname);
                              context.httpAjaxContext.ajax_rsp_assign_attri("", false, edtavName_Internalname, AV13Name);
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
      ...
      protected void E140W2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV21IsAuthorized_Id", AV21IsAuthorized_Id);
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vISAUTHORIZED_ID", GetSecureSignedToken( "", AV21IsAuthorized_Id, context));
      ...
      private void E160W2( )
      {
         ...
         {
            AV25GridWWPageCount = (long)((AV15RepositoryCollection.Count/ (decimal)(9))+1);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV25GridWWPageCount", StringUtil.LTrim( StringUtil.Str( (decimal)(AV25GridWWPageCount), 10, 0)));
         }
         AV27GridWWRecordCount = AV15RepositoryCollection.Count;
         ...
         {
            AV33GXV1 = 1;
            while ( AV33GXV1 <= AV15RepositoryCollection.Count )
            {
               AV14Repository = ((SdtGAMRepository)AV15RepositoryCollection.Item(AV33GXV1));
               ...
               AV34Btnupd_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7c63c2b9-483e-4035-b512-febf9186a274", "", context.GetTheme( )));
               edtavBtnupd_Tooltiptext = "";
               if ( AV18IsAuthorized_BtnUpd )
               {
                  edtavBtnupd_Link = formatLink("gamrepositoryconfiguration.aspx") + "?" + UrlEncode("" +AV11Id);
               }
               AV5BtnDlt = context.GetImagePath( "7695fe89-52c9-4b7e-871e-0e11548f823e", "", context.GetTheme( ));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, edtavBtndlt_Internalname, AV5BtnDlt);
               AV35Btndlt_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7695fe89-52c9-4b7e-871e-0e11548f823e", "", context.GetTheme( )));
               edtavBtndlt_Tooltiptext = "";
               if ( AV19IsAuthorized_BtnDlt )
               {
                  edtavBtndlt_Link = formatLink("gamrepositoryentry.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +AV11Id);
               }
               if ( AV21IsAuthorized_Id )
               {
                  edtavId_Link = formatLink("gamrepositoryconfiguration.aspx") + "?" + UrlEncode("" +AV11Id);
               }
               /* Load Method */
               if ( wbStart != -1 )
               {
      ...
      protected void E120W2( )
      {
         ...
         else
         {
            ...
            AV24GridWWCurrentPage = AV23PageToGo;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV24GridWWCurrentPage", StringUtil.LTrim( StringUtil.Str( (decimal)(AV24GridWWCurrentPage), 10, 0)));
      ...
      protected void S112( )
      {
         ...
         GXt_boolean1 = AV18IsAuthorized_BtnUpd;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "gamrepositoryconfiguration_Execute", out  GXt_boolean1) ;
         AV18IsAuthorized_BtnUpd = GXt_boolean1;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV18IsAuthorized_BtnUpd", AV18IsAuthorized_BtnUpd);
         if ( ! ( AV18IsAuthorized_BtnUpd ) )
         {
         ...
         GXt_boolean1 = AV20TempBoolean;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "gamrepositoryentry_Execute", out  GXt_boolean1) ;
         AV20TempBoolean = GXt_boolean1;
         if ( ! ( AV20TempBoolean ) )
         {
            bttBtnadd_Visible = 0;
      ...
      protected void S122( )
      {
         ...
         AV36GXV2 = 1;
         while ( AV36GXV2 <= AV8Errors.Count )
         {
            AV7Error = ((SdtGAMError)AV8Errors.Item(AV36GXV2));
      ...
      protected void wb_table1_24_0W2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilname_Internalname, StringUtil.RTrim( AV17FilName), StringUtil.RTrim( context.localUtil.Format( AV17FilName, "")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,29);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFilname_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilname_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 1, -1, -1, true, "GAMDescriptionShort", "left", true, "HLP_GAMWWRepositories.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_24_0W2e( true) ;
         }
         else
         {
            wb_table1_24_0W2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20189201942237", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("gamwwrepositories.js", "?20189201942241", false);
      ...
      protected void sendrow_382( )
      {
         ...
         if ( ( subGridww_Rows * 1 == 0 ) || ( nGXsfl_38_idx <= subGridww_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV6BtnUpd_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV6BtnUpd))&&String.IsNullOrEmpty(StringUtil.RTrim( AV34Btnupd_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV6BtnUpd)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV6BtnUpd)) ? AV34Btnupd_GXI : context.PathToRelativeUrl( AV6BtnUpd));
            ...
            StyleString = "";
            AV5BtnDlt_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV5BtnDlt))&&String.IsNullOrEmpty(StringUtil.RTrim( AV35Btndlt_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV5BtnDlt)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV5BtnDlt)) ? AV35Btndlt_GXI : context.PathToRelativeUrl( AV5BtnDlt));
            GridwwRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(String)edtavBtndlt_Internalname,(String)sImgUrl,(String)edtavBtndlt_Link,(String)"",(String)"",context.GetTheme( ),(int)edtavBtndlt_Visible,(short)1,(String)"",(String)edtavBtndlt_Tooltiptext,(short)0,(short)-1,(short)0,(String)"px",(short)0,(String)"px",(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)"WWActionColumn",(String)"",(String)"",(String)"",(String)"",(String)"",(String)"",(short)1,(bool)AV5BtnDlt_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridwwContainer.GetWrapped() == 1 )
            {
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRIDWW_nFirstRecordOnPage',nv:0},{av:'GRIDWW_nEOF',nv:0},{av:'subGridww_Rows',nv:0},{av:'AV17FilName',fld:'vFILNAME',pic:'',nv:''},{av:'AV18IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'AV19IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'AV21IsAuthorized_Id',fld:'vISAUTHORIZED_ID',pic:'',hsh:true,nv:false}],oparms:[{av:'AV18IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'edtavBtnupd_Visible',ctrl:'vBTNUPD',prop:'Visible'},{av:'AV19IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'edtavBtndlt_Visible',ctrl:'vBTNDLT',prop:'Visible'},{ctrl:'BTNADD',prop:'Visible'}]}");
         setEventMetadata("GRIDWW.LOAD","{handler:'E160W2',iparms:[{av:'AV17FilName',fld:'vFILNAME',pic:'',nv:''},{av:'AV18IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'AV19IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'AV21IsAuthorized_Id',fld:'vISAUTHORIZED_ID',pic:'',hsh:true,nv:false}],oparms:[{av:'AV25GridWWPageCount',fld:'vGRIDWWPAGECOUNT',pic:'ZZZZZZZZZ9',nv:0},{av:'edtavBtndlt_Visible',ctrl:'vBTNDLT',prop:'Visible'},{av:'AV11Id',fld:'vID',pic:'ZZZZZZZZZZZ9',nv:0},{av:'AV13Name',fld:'vNAME',pic:'',nv:''},{av:'AV6BtnUpd',fld:'vBTNUPD',pic:'',nv:''},{av:'edtavBtnupd_Tooltiptext',ctrl:'vBTNUPD',prop:'Tooltiptext'},{av:'edtavBtnupd_Link',ctrl:'vBTNUPD',prop:'Link'},{av:'AV5BtnDlt',fld:'vBTNDLT',pic:'',nv:''},{av:'edtavBtndlt_Tooltiptext',ctrl:'vBTNDLT',prop:'Tooltiptext'},{av:'edtavBtndlt_Link',ctrl:'vBTNDLT',prop:'Link'},{av:'edtavId_Link',ctrl:'vID',prop:'Link'}]}");
         setEventMetadata("GRIDWWPAGINATIONBAR.CHANGEPAGE","{handler:'E120W2',iparms:[{av:'GRIDWW_nFirstRecordOnPage',nv:0},{av:'GRIDWW_nEOF',nv:0},{av:'subGridww_Rows',nv:0},{av:'AV17FilName',fld:'vFILNAME',pic:'',nv:''},{av:'AV18IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'AV19IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'AV21IsAuthorized_Id',fld:'vISAUTHORIZED_ID',pic:'',hsh:true,nv:false},{av:'Gridwwpaginationbar_Selectedpage',ctrl:'GRIDWWPAGINATIONBAR',prop:'SelectedPage'},{av:'AV24GridWWCurrentPage',fld:'vGRIDWWCURRENTPAGE',pic:'ZZZZZZZZZ9',nv:0}],oparms:[{av:'AV24GridWWCurrentPage',fld:'vGRIDWWCURRENTPAGE',pic:'ZZZZZZZZZ9',nv:0},{av:'AV18IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'edtavBtnupd_Visible',ctrl:'vBTNUPD',prop:'Visible'},{av:'AV19IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'edtavBtndlt_Visible',ctrl:'vBTNDLT',prop:'Visible'},{ctrl:'BTNADD',prop:'Visible'}]}");
         setEventMetadata("GRIDWWPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E130W2',iparms:[{av:'GRIDWW_nFirstRecordOnPage',nv:0},{av:'GRIDWW_nEOF',nv:0},{av:'subGridww_Rows',nv:0},{av:'AV17FilName',fld:'vFILNAME',pic:'',nv:''},{av:'AV18IsAuthorized_BtnUpd',fld:'vISAUTHORIZED_BTNUPD',pic:'',nv:false},{av:'AV19IsAuthorized_BtnDlt',fld:'vISAUTHORIZED_BTNDLT',pic:'',nv:false},{av:'AV21IsAuthorized_Id',fld:'vISAUTHORIZED_ID',pic:'',hsh:true,nv:false},{av:'Gridwwpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDWWPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}],oparms:[{av:'subGridww_Rows',ctrl:'GRIDWW',prop:'Rows'},{av:'AV24GridWWCurrentPage',fld:'vGRIDWWCURRENTPAGE',pic:'ZZZZZZZZZ9',nv:0}]}");
         setEventMetadata("'DOADD'","{handler:'E110W1',iparms:[],oparms:[]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV34Btnupd_GXI = "";
         AV35Btndlt_GXI = "";
         AV9Filter = new SdtGAMRepositoryFilter(context);
         AV15RepositoryCollection = new GXExternalCollection<SdtGAMRepository>( context, "SdtGAMRepository", "GeneXus.Programs");
         AV8Errors = new GXExternalCollection<SdtGAMError>( context, "SdtGAMError", "GeneXus.Programs");
         AV10GAM = new SdtGAM(context);
         AV14Repository = new SdtGAMRepository(context);
      ...
      private bool AV18IsAuthorized_BtnUpd ;
      ...
      private bool AV20TempBoolean ;
      private bool GXt_boolean1 ;
      private bool AV6BtnUpd_IsBlob ;
      private bool AV5BtnDlt_IsBlob ;
      private String AV34Btnupd_GXI ;
      private String AV35Btndlt_GXI ;
      ...
      private SdtGAM AV10GAM ;
      private IGxDataStore dsGAM ;
      private IGxDataStore dsDefault ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXExternalCollection<SdtGAMError> AV8Errors ;
      private GXExternalCollection<SdtGAMRepository> AV15RepositoryCollection ;
      private GXWebForm Form ;
      private SdtGAMError AV7Error ;
      private SdtGAMRepositoryFilter AV9Filter ;
      private SdtGAMRepository AV14Repository ;
   }
